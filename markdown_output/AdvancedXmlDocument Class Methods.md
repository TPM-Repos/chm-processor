...
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2364.md)  
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [AddRule](topic2371.md)| Creates and Adds a new [ProjectDocumentRule](topic4399.md) to the document.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetDocumentRuleIds](topic2374.md)| Returns a Dictionary of rule XPaths and respective Rule Id.   
![Public Method](dotnetimages/publicMethod.gif)| GetLifetimeService|  (Inherited from System.MarshalByRefObject)  
![Public Method](dotnetimages/publicMethod.gif)| [GetProjectDocumentRule](topic2375.md)| Gets the [ProjectDocumentRule](topic4399.md) associated with this Id.   
![Public Method](dotnetimages/publicMethod.gif)| [GetRuleForPath](topic2376.md)| Gets the [ProjectDocumentRule](topic4399.md) at the given XPath.   
![Public Method](dotnetimages/publicMethod.gif)| [GetRuleResults](topic2377.md)| Gets a Dictionary of all Rule Ids for this document and their evaluated result.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [GenerateCore](topic2372.md)| Overridden. Generates a new driven advanced xml document.   
![Protected Method](dotnetimages/protectedMethod.gif)| [GeneratePreviewCore](topic2373.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [InitializeExistingCore](topic2378.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [InitializeNewCore](topic2379.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [ReplaceNamespaceDeclaration](topic2380.md)|   
