...
---|---  
ProjectSaveException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic4750.md)  
...
The following tables list the members exposed by [ProjectSaveException](topic4750.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ProjectSaveException Constructor](topic4756.md)| Overloaded.   
Top
