...
---|---  
InvalidCharactersException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic3514.md)  
...
The following tables list the members exposed by [InvalidCharactersException](topic3514.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [InvalidCharactersException Constructor](topic3520.md)| Overloaded.   
Top
