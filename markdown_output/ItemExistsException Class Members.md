...
---|---  
ItemExistsException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic3561.md)  
...
The following tables list the members exposed by [ItemExistsException](topic3561.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ItemExistsException Constructor](topic3567.md)| Overloaded.   
Top
