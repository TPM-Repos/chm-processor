...
---|---  
RegenerateAndOverwriteComponentTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12446.md)  
...
The following tables list the members exposed by [RegenerateAndOverwriteComponentTask](topic12446.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [RegenerateAndOverwriteComponentTask Constructor](topic12452.md)|   
Top
...
| Name| Description  
---|---|---  
![Public Property](dotnetimages/publicProperty.gif)| [Component](topic12454.md)| Gets/sets the component that'll be marked for generation and have its overwrite flag set.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12455.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12453.md)| Overridden.   
