...
---|---  
ReadTextFileTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12395.md)  
...
The following tables list the members exposed by [ReadTextFileTask](topic12395.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ReadTextFileTask Constructor](topic12401.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [FilePath](topic12403.md)| Gets/sets the path to the file to be encoded.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12404.md)| Overridden. Gets the class name used when writing to the report.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12402.md)| Overridden.   
