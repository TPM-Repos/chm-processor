...
---|---  
InvalidRuleException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic3539.md)  
...
The following tables list the members exposed by [InvalidRuleException](topic3539.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [InvalidRuleException Constructor](topic3545.md)| Overloaded.   
Top
