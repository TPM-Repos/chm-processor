...
---|---  
ClipboardException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2496.md)  
...
The following tables list the members exposed by [ClipboardException](topic2496.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ClipboardException Constructor](topic2502.md)| Overloaded.   
Top
