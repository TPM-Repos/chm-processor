...
---|---  
Label Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8235.md)  
...
The following tables list the members exposed by [Label](topic8235.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [Label Constructor](topic8241.md)| Initializes a new instance of the [Label](topic8235.md) type.   
Top
...
| Name| Description  
---|---|---  
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [BorderColorProperty](topic8256.md)| Provides the property store for the [BorderColor](topic8245.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [BorderRadiusProperty](topic8257.md)| Provides the property store for the [BorderRadius](topic8246.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [BorderStyleProperty](topic8258.md)| Provides the property store for the [BorderStyle](topic8247.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [BorderWidthProperty](topic8259.md)| Provides the property store for the [BorderWidth](topic8248.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [EffectiveTextFontProperty](topic8260.md)| Provides the property store for the effective text font.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PaddingProperty](topic8261.md)| Provides the property store for the [Padding](topic8249.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TextColorProperty](topic8262.md)| Provides the property store for the [TextColor](topic8251.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TextFontProperty](topic8263.md)| Provides the property store for the [TextFont](topic8253.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TextHorizontalAlignmentProperty](topic8264.md)| Provides the property store for the [TextHorizontalAlignment](topic8254.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TextProperty](topic8265.md)| Provides the property store for the [Text](topic8250.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TextVerticalAlignmentProperty](topic8266.md)| Provides the property store for the [TextVerticalAlignment](topic8255.md) property.   
Top
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic8242.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnParentDefaultFontChanged](topic8243.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic8244.md)| Overridden.   
