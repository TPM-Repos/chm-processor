...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [GetVersionHistory](topic14563.md)| Gets the version history for the feature parameter.   
![Public Method](dotnetimages/publicMethod.gif)| [SetRuleAndComment](topic14564.md)| Sets the rule and comment in a single operation.   
Top
