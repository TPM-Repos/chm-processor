...
---|---  
UpdateTeamMembersCanEditAllSpecificationsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12753.md)  
...
The following tables list the members exposed by [UpdateTeamMembersCanEditAllSpecificationsTask](topic12753.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [UpdateTeamMembersCanEditAllSpecificationsTask Constructor](topic12759.md)|   
Top
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12761.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12760.md)| Overridden.   
