...
---|---  
ClipboardButton Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7606.md)  
...
The following tables list the members exposed by [ClipboardButton](topic7606.md).

# ![](dotnetimages/collapse.gif)Public Fields

| Name| Description  
---|---|---  
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [ButtonTextResetDurationProperty](topic7621.md)| Provides the property store for the [ButtonTextResetDuration](topic7612.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PictureDefaultProperty](topic7622.md)| Provides the property store for the [PictureDefault](topic7613.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PictureHoverProperty](topic7623.md)| Provides the property store for the [PictureHover](topic7614.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PicturePressedProperty](topic7624.md)| Provides the property store for the [PicturePressed](topic7615.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PictureSizeModeProperty](topic7625.md)| Provides the property store for the [PictureSizeMode](topic7616.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PictureStyleProperty](topic7626.md)| Provides the property store for the [PictureStyle](topic7617.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TargetControlNameProperty](topic7627.md)| Provides the property store for the [TargetControlName](topic7618.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TextOnErrorProperty](topic7628.md)| Provides the property store for the [TextOnError](topic7619.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TextOnSuccessProperty](topic7629.md)| Provides the property store for the [TextOnSuccess](topic7620.md) property.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [BorderColor](topic7347.md)| Gets/sets the border color for the control. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [BorderColorDisabled](topic7348.md)| Gets/sets the border color for the control when disabled. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [BorderColorHover](topic7349.md)| Gets/sets the border color for the control on hover. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [BorderColorPressed](topic7350.md)| Gets/sets the border color for the control when pressed. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [BorderRadius](topic7351.md)| Gets/sets the border radius of the control. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [BorderRadiusHover](topic7352.md)| Gets/sets the border radius of the control when hovered. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [BorderRadiusPressed](topic7353.md)| Gets/sets the border radius of the control when pressed. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [BorderWidth](topic7354.md)| Gets/sets the border width for the control. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [ButtonBackgroundColor](topic7355.md)| Gets/sets the background color of the button. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [ButtonBackgroundColorDisabled](topic7356.md)| Gets/sets the background color of the button when disabled. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [ButtonBackgroundColorHover](topic7357.md)| Gets/sets the background color of the button when hovered. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [ButtonBackgroundColorPressed](topic7358.md)| Gets/sets the background color of the button when pressed. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [ButtonOpacityDisabled](topic7359.md)| Gets/sets the opacity of the button when the control is disabled. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [ButtonTextResetDuration](topic7612.md)| Gets/sets the duration of the delay after which the text of the button reverts to the control's default text.   
...
![Public Property](dotnetimages/publicProperty.gif)| [OutlineColorFocus](topic7360.md)| Gets/sets the outline color when focused. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
...
![Public Property](dotnetimages/publicProperty.gif)| [PictureDefault](topic7613.md)| Gets/sets the location of the default picture to use as the default image for the button.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureHover](topic7614.md)| Gets/sets the location of the picture to use as the image for the button when it's in a hover state.   
![Public Property](dotnetimages/publicProperty.gif)| [PicturePressed](topic7615.md)| Gets/sets the location of the picture to use as the image for the button when it's in a pressed state.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureSizeMode](topic7616.md)| Gets/sets the picture sizing mode for the button.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureStyle](topic7617.md)| Gets/sets the picture appearance style for the button.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TargetControlName](topic7618.md)| Gets/sets the name of the control whose value to copy.   
![Public Property](dotnetimages/publicProperty.gif)| [Text](topic7361.md)| Gets/sets the text shown in the button. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [TextColor](topic7362.md)| Gets/sets the color used for the button's text. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [TextColorDisabled](topic7363.md)| Gets/sets the color used for the button's text when disabled. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [TextColorHover](topic7364.md)| Gets/sets the color used for the button's text when hovered. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [TextColorPressed](topic7365.md)| Gets/sets the color used for the button's text when pressed. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [TextFont](topic7366.md)| Gets/sets the font used for the button's text. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [TextHorizontalAlignment](topic7367.md)| Gets/Sets the horizontal alignment of text on this button. (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
![Public Property](dotnetimages/publicProperty.gif)| [TextOnError](topic7619.md)| Gets/sets the text to display when there was an error copying the value.   
![Public Property](dotnetimages/publicProperty.gif)| [TextOnSuccess](topic7620.md)| Gets/sets the text to display when value was successfully copied.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic7344.md)|  (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnParentDefaultFontChanged](topic7345.md)|  (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic7346.md)|  (Inherited from [DriveWorks.Forms.ButtonBase](topic7338.md))  
