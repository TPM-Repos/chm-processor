...
| Name| Description  
---|---|---  
Public Method| [ClearRanges](topic5915.md)| Removes all Tagged Elements from the list of ranges to be driven.   
...
Public Method| [GetRange](topic5918.md)| Get the rule for a driven range.   
Public Method| [GetRangeNames](topic5919.md)| Gets a list of all the driven ranges names.   
Public Method| [GetRangeValues](topic5920.md)| Gets all the ranges resolved values.   
Public Method| [LoadRangesFromFile](topic5923.md)| Matches range information with ranges from file. Creates missing ranges and removes unused ones.   
Public Method| [RangeExists](topic5924.md)| Sees if a given driven range exists with a specific name.   
Public Method| [RemoveRange](topic5925.md)| Removes a range from the list of ranges to be driven.   
Public Method| [SetRange](topic5926.md)| Overloaded. Sets/adds ranges to be driven.   
...
Protected Method| [GenerateCore](topic5916.md)| Overridden.   
Protected Method| [GeneratePreviewCore](topic5917.md)| Overridden.   
...
Protected Method| [InitializeExistingCore](topic5921.md)| Overridden.   
Protected Method| [InitializeNewCore](topic5922.md)| Overridden.   
