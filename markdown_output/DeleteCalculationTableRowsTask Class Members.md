...
---|---  
DeleteCalculationTableRowsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12122.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification.StandardTasks Namespace](topic11896.md) : DeleteCalculationTableRowsTask Class  
---  
...
The following tables list the members exposed by [DeleteCalculationTableRowsTask](topic12122.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [DeleteCalculationTableRowsTask Constructor](topic12128.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [FieldNames](topic12130.md)| Gets/sets the column names to match against, delimited by pipe bars.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MatchValues](topic12131.md)| Gets/sets the values to match against, based on the fields specified in the [FieldNames](topic12130.md) property. Values should be delimited with pipe bars.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TableName](topic12133.md)| Gets/sets the name of the calculation table to remove rows from.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12132.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12129.md)| Overridden.   
