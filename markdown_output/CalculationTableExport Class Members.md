...
---|---  
CalculationTableExport Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2439.md)  
...
![Public Method](dotnetimages/publicMethod.gif)| [GetDetails](topic2447.md)| Gets the details for this document.   
![Public Method](dotnetimages/publicMethod.gif)| [GetExportSummary](topic2448.md)| Gets a summary of changes that would take place if the document was generated now.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [GenerateCore](topic2446.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [InitializeNewCore](topic2449.md)| Overridden.   
