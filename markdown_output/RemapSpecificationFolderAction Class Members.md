RemapSpecificationFolderAction Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9970.md)  
...
The following tables list the members exposed by [RemapSpecificationFolderAction](topic9970.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [SpecificationsFolder](topic9978.md)| The new specification folder.   
![Public Property](dotnetimages/publicProperty.gif)| [Status](topic9979.md)| The current status of the action.   
![Public Property](dotnetimages/publicProperty.gif)| [StatusMessage](topic9980.md)| Overridden. The current human readable status of this action.   
...
| Name| Description  
---|---|---  
Public Method| [Execute](topic9976.md)| Overridden. Executes this action.   
Public Method| [GetCanExecute](topic9977.md)| Overridden. Checks to see if the action can be executed or not.   
Top
