...
---|---  
Task Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11629.md)  
...
The following tables list the members exposed by [Task](topic11629.md).

# Public Properties

| Name| Description  
---|---|---  
![Public Property](dotnetimages/publicProperty.gif)| [Conditions](topic11647.md)| Gets a condition manager which can be used to add and work with conditions which can control whether the task gets executed.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Flow](topic11648.md)| Overridden. Gets the [DriveWorks.EventFlow.FlowBase](topic6999.md) that owns this Task.   
![Public Property](dotnetimages/publicProperty.gif)| [Left](topic11649.md)| Overridden. Gets the left position of this task.   
![Public Property](dotnetimages/publicProperty.gif)| [NavigationInput](topic11650.md)| Overridden. Gets the end point that allows logical navigation connections to be made to this task.   
![Public Property](dotnetimages/publicProperty.gif)| [NavigationOutput](topic11651.md)| Overridden. Gets the end point that allows logical navigation connections to be made from this task.   
![Public Property](dotnetimages/publicProperty.gif)| [Outputs](topic11652.md)| Overridden. Gets the collection of all outputs that belong to this task.   
![Public Property](dotnetimages/publicProperty.gif)| [Properties](topic11653.md)| Overridden. Gets access to the property registration service.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Title](topic11655.md)| Overridden. Gets/sets the human-readable title of the task.   
![Public Property](dotnetimages/publicProperty.gif)| [Top](topic11656.md)| Overridden. Gets the top position of this task.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Width](topic11657.md)| Overridden. Gets/sets the width of the task.   
Top
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic11654.md)| Overridden. Gets the class name to be written to the report.   
...
![Public Method](dotnetimages/publicMethod.gif)| [Delete](topic11636.md)| Deletes the condition.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetElement](topic11640.md)| Returns a deep copy of this task's Xml Element.   
...
![Public Method](dotnetimages/publicMethod.gif)| [TryGetOutputEndpoint](topic11646.md)| Overridden. Attempts to retrieve the end point with the given name.   
Top
...
| Name| Description  
---|---|---  
![Protected Method](dotnetimages/protectedMethod.gif)| [AssertNotDeleted](topic11635.md)| Throws an instance of the [DriveWorks.ItemDeletedException](topic3549.md) if the item has been deleted.   
![Protected Method](dotnetimages/protectedMethod.gif)| [DeleteCore](topic11637.md)| Performs any clean-up required when overridden by a derived class.   
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic11638.md)| When overridden by a derived class, executes the action represented by the task.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [GetConfirmationMessage](topic11639.md)| When overridden by a derived class, gets a confirmation message which should be shown to an interactive user before executing the task sequence to which task belongs.   
![Protected Method](dotnetimages/protectedMethod.gif)| [InitializeMetadata](topic11641.md)| Called when the backing store for this task has been initialized and the meta data is available to be read.   
![Protected Method](dotnetimages/protectedMethod.gif)| [IsDeferred](topic11642.md)| Determines whether the task should be executed after the design master for the specification is saved.   
![Protected Method](dotnetimages/protectedMethod.gif)| [IsDeleteContextTask](topic11643.md)| Determines whether the task will be deleting the specification context in it's execution.   
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic11644.md)| Determines whether the task requires the specification context to be open.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [RequiresSingleContext](topic11645.md)| Determines whether the task can be executed if there is more than one specification selected.   
...
| Name| Description  
---|---|---  
![Public Event](dotnetimages/publicEvent.gif)| [Deleted](topic11658.md)| Occurs when the task is deleted.   
