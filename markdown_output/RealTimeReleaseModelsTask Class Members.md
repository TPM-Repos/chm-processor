...
---|---  
RealTimeReleaseModelsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12405.md)  
...
The following tables list the members exposed by [RealTimeReleaseModelsTask](topic12405.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Models](topic12414.md)| Gets/sets the identifiers of the models to release, where "*" is a special identifier meaning all models.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetResults](topic12412.md)| Releases the configured models and returns the results.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12411.md)| Overridden. Overridden to implement the logic required to release one or more models for realtime.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12413.md)| Overridden. Overridden to indicate that a running specification is required by the task to execute.   
