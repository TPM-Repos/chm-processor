...
Public Method| [GetResults](topic12412.md)| Releases the configured models and returns the results.   
...
Protected Method| [Execute](topic12411.md)| Overridden. Overridden to implement the logic required to release one or more models for realtime.   
...
Protected Method| [IsRunningRequired](topic12413.md)| Overridden. Overridden to indicate that a running specification is required by the task to execute.   
