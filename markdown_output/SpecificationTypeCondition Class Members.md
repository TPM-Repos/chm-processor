SpecificationTypeCondition Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11889.md)  
...
The following tables list the members exposed by [SpecificationTypeCondition](topic11889.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Type](topic11895.md)| Gets the type of specification to check for.   
...
![Public Method](dotnetimages/publicMethod.gif)| [Delete](topic10811.md)| Deletes the condition. (Inherited from [DriveWorks.Specification.Condition](topic10804.md))  
...
![Public Method](dotnetimages/publicMethod.gif)| [GetElement](topic10813.md)| Returns a deep copy of this condition's Xml Element. (Inherited from [DriveWorks.Specification.Condition](topic10804.md))  
...
![Public Method](dotnetimages/publicMethod.gif)| [TryGetOutputEndpoint](topic10814.md)| Attempts to retrieve the end point with the given name. (Inherited from [DriveWorks.Specification.Condition](topic10804.md))  
Top
...
| Name| Description  
---|---|---  
![Protected Method](dotnetimages/protectedMethod.gif)| [AssertNotDeleted](topic10810.md)| Throws an instance of the [DriveWorks.ItemDeletedException](topic3549.md) if the item has been deleted. (Inherited from [DriveWorks.Specification.Condition](topic10804.md))  
![Protected Method](dotnetimages/protectedMethod.gif)| [DeleteCore](topic10812.md)| Performs any clean-up required when overridden by a derived class. (Inherited from [DriveWorks.Specification.Condition](topic10804.md))  
...
[SpecificationTypeCondition Class](topic11889.md)   
