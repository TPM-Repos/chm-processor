...
---|---  
INotifyChanged Interface Members   
See Also Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2257.md)  
...
The following tables list the members exposed by [INotifyChanged](topic2257.md).
