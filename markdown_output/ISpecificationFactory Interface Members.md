...
---|---  
ISpecificationFactory Interface Members   
See Also Methods [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic471.md)  
...
The following tables list the members exposed by [ISpecificationFactory](topic471.md).
