...
---|---  
DriveConstantValueTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12232.md)  
...
The following tables list the members exposed by [DriveConstantValueTask](topic12232.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [DriveConstantValueTask Constructor](topic12238.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [ConstantName](topic12241.md)| Gets/sets the flow property that is control of the name of the constant to drive the value into.   
![Public Property](dotnetimages/publicProperty.gif)| [ConstantValue](topic12242.md)| Gets/sets the flow property that is in control of the new value to drive into the constant.   
![Public Property](dotnetimages/publicProperty.gif)| [ConstantValueNative](topic12243.md)| Gets the native flow property that is in control of the new value to drive into the constant.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12244.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12239.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12240.md)| Overridden.   
