...
---|---  
StartSpecificationTimerTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12661.md)  
...
The following tables list the members exposed by [StartSpecificationTimerTask](topic12661.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Count](topic12668.md)| Gets/sets the number of times that the macro should be executed.   
![Public Property](dotnetimages/publicProperty.gif)| [CounterConstant](topic12669.md)| Gets/sets the name of the constant where the timer's counter should be stored.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Interval](topic12670.md)| Gets/sets the interval of how often the timer should run.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MacroArgument](topic12671.md)| Gets/sets the optional argument to pass to the macro.   
![Public Property](dotnetimages/publicProperty.gif)| [MacroName](topic12672.md)| Gets/sets the name of the macro to run.   
...
![Public Property](dotnetimages/publicProperty.gif)| [StayOnSchedule](topic12674.md)| Gets/sets whether the timer should stay on schedule or not.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TimerName](topic12675.md)| Gets/sets the name of the Timer to run.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12673.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12667.md)| Overridden.   
