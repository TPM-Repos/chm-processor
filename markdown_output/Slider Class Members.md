...
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8900.md)  
...
The following tables list the members exposed by [Slider](topic8900.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [Slider Constructor](topic8906.md)| Initializes a new instance of the [Slider](topic8900.md) type.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [DefaultValue](topic8915.md)| Gets/sets the default value of the control.   
![Public Property](dotnetimages/publicProperty.gif)| [EffectiveMaximum](topic8916.md)| Gets the effective maximum value of the spin button.   
![Public Property](dotnetimages/publicProperty.gif)| [EffectiveMinimum](topic8917.md)| Gets the effective minimum value of the spin button.   
![Public Property](dotnetimages/publicProperty.gif)| [EffectiveValue](topic8918.md)| Gets the effective value of the spin button.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HasInputValue](topic8919.md)| Overridden. Returns true if the current control has an input value. A control's input value is the main property of the control, editable through the control's interface.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Increment](topic8920.md)| Gets/sets the slider's increment value.   
![Public Property](dotnetimages/publicProperty.gif)| [InputOpacityDisabled](topic8921.md)| Gets/sets the opacity of the input when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [InputSpacing](topic8922.md)| Gets/sets the spacing around inputs in the control.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MacroArgument](topic8923.md)| Gets/sets the argument for the macro that is invoked when this control value changes.   
![Public Property](dotnetimages/publicProperty.gif)| [Maximum](topic8924.md)| Gets/sets the slider's maximum value.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Minimum](topic8925.md)| Gets/sets the slider's minimum value.   
...
![Public Property](dotnetimages/publicProperty.gif)| [OnChange](topic8926.md)| Gets/sets the name of the macro to run when the value of this control changes.   
![Public Property](dotnetimages/publicProperty.gif)| [Orientation](topic8927.md)| Gets/sets the slider orientation.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ReverseDirection](topic8928.md)| Gets/Sets whether the direction of the slider is reversed.   
![Public Property](dotnetimages/publicProperty.gif)| [ShowLimits](topic8929.md)| Gets/sets whether to show the value limits on the control.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Text](topic8930.md)| Gets/sets the text shown in the control.   
![Public Property](dotnetimages/publicProperty.gif)| [TextColor](topic8931.md)| Gets/sets the text color of the control.   
![Public Property](dotnetimages/publicProperty.gif)| [TextFont](topic8932.md)| Gets/sets the font used for the control's text.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBackgroundColor](topic8933.md)| Gets/sets the background color of the slider's thumb.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBackgroundColorDisabled](topic8934.md)| Gets/sets the background color of the slider's thumb when the control is disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBackgroundColorHover](topic8935.md)| Gets/sets the background color of the slider's thumb when hovered.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBackgroundColorPressed](topic8936.md)| Gets/sets the background color of the slider's thumb when pressed.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBorderColor](topic8937.md)| Gets/sets the border color of the slider's thumb.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBorderColorDisabled](topic8938.md)| Gets/sets the border color of the slider's thumb when the control is disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBorderColorHover](topic8939.md)| Gets/sets the border color of the slider's thumb when hovered.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBorderColorPressed](topic8940.md)| Gets/sets the border color of the slider's thumb when pressed.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBorderRadius](topic8941.md)| Gets/sets the border radius of the slider's thumb.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbBorderWidth](topic8942.md)| Gets/sets the border width of the slider's thumb.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbImage](topic8943.md)| Gets/Sets the Image which will be used instead of the slider's thumb.   
![Public Property](dotnetimages/publicProperty.gif)| [ThumbOutlineColorFocus](topic8944.md)| Gets/sets the outline color of the slider's thumb when focused.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TrackBorderRadius](topic8945.md)| Gets/sets the border radius of the slider's track.   
![Public Property](dotnetimages/publicProperty.gif)| [TrackColor](topic8946.md)| Gets/sets the color of the slider's track.   
![Public Property](dotnetimages/publicProperty.gif)| [Value](topic8947.md)| Gets/sets the current value.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [ClearInputValue](topic8907.md)| Overridden. Sets the current value to zero.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetInputValue](topic8908.md)| Overridden. Returns the current value of the control.   
...
![Public Method](dotnetimages/publicMethod.gif)| [SetInputValue](topic8912.md)| Overloaded. Overridden. Sets the current value of the control.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic8909.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnParentDefaultFontChanged](topic8910.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic8911.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Validate](topic8914.md)| Overridden.   
Top
