...
Shows more information about missing components. 
...
---|---  
    ...
    Public Const MissingComponentsInfo As String  
...
---|---  
    ...
    Dim value As String
     
    value = [CommandNames](topic15420.md).MissingComponentsInfo  
  
C#|   
---|---  
      
    
    public const string MissingComponentsInfo  
