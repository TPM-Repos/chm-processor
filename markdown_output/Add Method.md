...
---|---  
[Add(String)](topic11474.md)| Adds a new macro with the given name.   
[Add(String,SpecificationMacroCategory)](topic11475.md)| Adds a new macro with the given name and category   
[Add(XElement)](topic11476.md)| Adds a new macro created from the given xElement.   
