...
Provides the property store for the [PreviewCompleteMacroName](topic8760.md) property. 
...
---|---  
    ...
    Public Shared ReadOnly PreviewCompleteMacroNameProperty As [DynamicProperty](topic9398.md)  
...
---|---  
    ...
     
    value = [PreviewControl](topic8709.md).PreviewCompleteMacroNameProperty  
  
C#|   
---|---  
      
    
    public static readonly [DynamicProperty](topic9398.md) PreviewCompleteMacroNameProperty  
