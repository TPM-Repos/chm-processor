...
---|---  
GenerationFailedException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic15228.md)  
...
The following tables list the members exposed by [GenerationFailedException](topic15228.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [GenerationFailedException Constructor](topic15234.md)| Overloaded.   
Top
