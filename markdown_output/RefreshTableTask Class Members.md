...
---|---  
RefreshTableTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12415.md)  
...
The following tables list the members exposed by [RefreshTableTask](topic12415.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [RefreshTableTask Constructor](topic12421.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [TableName](topic12425.md)| Gets/sets the flow property that is in control of the name(s) of the table(s) to refresh.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12424.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12422.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12423.md)| Overridden.   
...
[RefreshTableTask Class](topic12415.md)   
