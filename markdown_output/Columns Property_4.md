...
---|---  
    ...
    Public ReadOnly Property Columns As [Columns](topic2516.md)  
...
---|---  
    ...
    public [Columns](topic2516.md) Columns {get;}  
  
#### Property Value

An instance of the [Columns](topic4527.md) type which can be used to query, add, remove, and re-order columns.
