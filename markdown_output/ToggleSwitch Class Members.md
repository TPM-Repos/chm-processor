...
---|---  
ToggleSwitch Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9266.md)  
...
The following tables list the members exposed by [ToggleSwitch](topic9266.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Checked](topic9279.md)| Gets/sets whether the toggle switch control is checked.   
![Public Property](dotnetimages/publicProperty.gif)| [DefaultValue](topic9280.md)| Gets/sets the default value of the control.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HasInputValue](topic9281.md)| Overridden. Returns true if the current control has an input value. A control's input value is the main property of the control, editable through the control's interface.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MacroArgument](topic9282.md)| Gets/sets the argument for the macro that is invoked when this control value changes.   
...
![Public Property](dotnetimages/publicProperty.gif)| [OnChange](topic9283.md)| Gets/sets the name of the macro to run when the value of this control changes.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ShowToggleIndicators](topic9284.md)| Gets/sets the display of indicators on the toggle control.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ToggleBackgroundColor](topic9285.md)| Gets/sets the toggle's background color.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleBackgroundColorChecked](topic9286.md)| Gets/sets the toggle's background color when checked.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleBackgroundColorDisabled](topic9287.md)| Gets/sets the toggle's background color when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleBorderColor](topic9288.md)| Gets/sets the toggle's border color.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleBorderColorChecked](topic9289.md)| Gets/sets the toggle's border color when checked.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleBorderColorDisabled](topic9290.md)| Gets/sets the toggle's border color when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleBorderWidth](topic9291.md)| Gets/sets the toggle's border width.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleHandleColor](topic9292.md)| Gets/sets the toggle's handle color.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleHandleColorChecked](topic9293.md)| Gets/sets the toggle's handle color when checked.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleHandleColorDisabled](topic9294.md)| Gets/sets the toggle's handle color when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleIndicatorColor](topic9295.md)| Gets/sets the color of the toggle's indicators.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleIndicatorColorChecked](topic9296.md)| Gets/sets the color of the toggle's indicators when checked.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleIndicatorColorDisabled](topic9297.md)| Gets/sets the color of the toggle's indicators when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleOpacityDisabled](topic9298.md)| Gets/sets the opacity of the toggle when the control is disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleSize](topic9299.md)| Gets/sets the size of the toggle element in the control.   
![Public Property](dotnetimages/publicProperty.gif)| [ToggleSwitchAlignment](topic9300.md)| Gets/sets the alignment of the toggle switch with respect to its caption.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [ClearInputValue](topic9272.md)| Overridden. Sets the checked state to false.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetInputValue](topic9273.md)| Overridden. Returns the current checked state of the control.   
...
![Public Method](dotnetimages/publicMethod.gif)| [SetCheckedValue](topic9276.md)| Sets the [ToggleSwitch](topic9266.md)'s [CheckedSourceProperty](topic9302.md) and temporarily registers the source of this change.   
![Public Method](dotnetimages/publicMethod.gif)| [SetInputValue](topic9277.md)| Overloaded. Overridden. Sets the checked state of the control.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic9274.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic9275.md)| Overridden.   
