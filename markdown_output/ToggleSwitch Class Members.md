...
| Name| Description  
---|---|---  
Public Method| [ClearInputValue](topic9272.md)| Overridden. Sets the checked state to false.   
...
Public Method| [GetInputValue](topic9273.md)| Overridden. Returns the current checked state of the control.   
...
Public Method| [SetCheckedValue](topic9276.md)| Sets the [ToggleSwitch](topic9266.md)'s [CheckedSourceProperty](topic9302.md) and temporarily registers the source of this change.   
Public Method| [SetInputValue](topic9277.md)| Overloaded. Overridden. Sets the checked state of the control.   
...
Protected Method| [OnDataProviderInitialized](topic9274.md)| Overridden.   
...
Protected Method| [OnValueChanged](topic9275.md)| Overridden.   
