...
---|---  
    ...
    Public Property RowHoverBackgroundColor As [SimpleColor](topic8856.md)  
...
---|---  
    ...
     
    instance.RowHoverBackgroundColor = value
     
    value = instance.RowHoverBackgroundColor  
  
C#|   
---|---  
      
    
    public [SimpleColor](topic8856.md) RowHoverBackgroundColor {get; set;}  
