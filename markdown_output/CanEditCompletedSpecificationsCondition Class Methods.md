...
---|---  
CanEditCompletedSpecificationsCondition Class Methods   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11837.md)  
...
For a list of all members of this type, see [CanEditCompletedSpecificationsCondition members](topic11838.md).
