...
Public Method| [GetAllowedFileExtensions](topic9329.md)| Gets a list of extensions for the files that are allowed to be uploaded with this control.   
...
Public Method| [GetFileSizeLimitInBytes](topic9330.md)| Returns the value of the [FileSizeLimit](topic9336.md) property converted to bytes.   
...
Public Method| [HandleUploadAsync](topic9331.md)| Takes the specified inputs and completes the upload process for this control asynchronously.   
...
Protected Method| [Validate](topic9332.md)| Overridden.   
Top
