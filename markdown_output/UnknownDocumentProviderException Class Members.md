...
---|---  
UnknownDocumentProviderException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic5772.md)  
...
The following tables list the members exposed by [UnknownDocumentProviderException](topic5772.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [UnknownDocumentProviderException Constructor](topic5778.md)| Overloaded.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [DocumentName](topic5783.md)| The name of the document.   
![Public Property](dotnetimages/publicProperty.gif)| [DocumentType](topic5784.md)| The type of the document.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetObjectData](topic5782.md)| Overridden.   
