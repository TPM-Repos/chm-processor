...
---|---  
[RegisterAnyProperty(String)](topic10912.md)| Creates a new specification flow property which can store any data. Static values will always be represented as strings.   
