...
---|---  
DataTableDesignerAttribute Class Members   
See Also Properties Methods [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic1478.md)  
...
The following tables list the members exposed by [DataTableDesignerAttribute](topic1478.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [DataTableDesignerAttribute Constructor](topic1484.md)| Initializes a new instance of the [DataTableDesignerAttribute](topic1478.md) attribute class.   
Top
