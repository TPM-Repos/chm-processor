...
Gets the name of the parameter responsible for driving the scale output (number). 
...
---|---  
    ...
    Public Const DxfScaleOutput As String  
...
---|---  
    ...
    Dim value As String
     
    value = [FileFormatStandardParameters](topic13624.md).DxfScaleOutput  
  
C#|   
---|---  
      
    
    public const string DxfScaleOutput  
