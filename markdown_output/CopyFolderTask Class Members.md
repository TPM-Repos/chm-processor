...
---|---  
CopyFolderTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12072.md)  
...
The following tables list the members exposed by [CopyFolderTask](topic12072.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [DestinationFolderPath](topic12079.md)| Gets/sets the path to which to copy or move the folder.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Move](topic12080.md)| Gets/sets whether to move the folder (TRUE) or copy it (FALSE).   
...
![Public Property](dotnetimages/publicProperty.gif)| [Overwrite](topic12081.md)| Gets/sets whether to overwrite the destination folder if it already exists.   
...
![Public Property](dotnetimages/publicProperty.gif)| [SourceFolderPath](topic12083.md)| Gets/sets the path to the source folder.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12082.md)| Overridden. Gets the class name used when writing to the report.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12078.md)| Overridden.   
