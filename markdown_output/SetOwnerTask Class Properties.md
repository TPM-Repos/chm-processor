...
---|---  
SetOwnerTask Class Properties   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12566.md)  
...
For a list of all members of this type, see [SetOwnerTask members](topic12567.md).
