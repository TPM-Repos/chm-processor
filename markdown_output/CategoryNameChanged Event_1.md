...
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic4981.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks Namespace](topic2159.md) > [ProjectVariableCategories Class](topic4966.md) : CategoryNameChanged Event  
---  
...
---|---  
    ...
    Public Event CategoryNameChanged As [VariableCategoryChangedEventHandler](topic5937.md)  
...
---|---  
    ...
    public event [VariableCategoryChangedEventHandler](topic5937.md) CategoryNameChanged  
