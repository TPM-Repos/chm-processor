...
---|---  
GenerationEngineException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic15218.md)  
...
The following tables list the members exposed by [GenerationEngineException](topic15218.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [GenerationEngineException Constructor](topic15224.md)| Overloaded.   
Top
