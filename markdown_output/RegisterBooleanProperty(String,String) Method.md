...
---|---  
RegisterBooleanProperty(String,String) Method   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic10917.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification Namespace](topic10764.md) > [FlowProperties Class](topic10905.md) > [RegisterBooleanProperty Method](topic10915.md) : RegisterBooleanProperty(String,String) Method  
---  
...
---|---  
    ...
     
    value = instance.RegisterBooleanProperty(name, description)  
