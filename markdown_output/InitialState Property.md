...
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification Namespace](topic10764.md) > [SpecificationFlowDefinition Class](topic11387.md) : InitialState Property  
---  
...
---|---  
    ...
    Public Property InitialState As [State](topic11559.md)  
...
---|---  
    ...
    public [State](topic11559.md) InitialState {get; set;}  
