WebFrameControl Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9356.md)  
...
The following tables list the members exposed by [WebFrameControl](topic9356.md).

# Public Fields

| Name| Description  
---|---|---  
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [UrlProperty](topic9364.md)| Provides the backing store for the [Url](topic9363.md) property.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [SupportsTooltips](topic9362.md)| Overridden. Gets whether this control supports tooltips.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Url](topic9363.md)| Gets/sets the URL of the page to display in the control.   
