...
---|---  
ContainerControlBase Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7684.md)  
...
The following tables list the members exposed by [ContainerControlBase](topic7684.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [ContainerControlBase Constructor](topic7690.md)| Initializes a new instance of the [ContainerControlBase](topic7684.md) type.   
Top
...
![Public Method](dotnetimages/publicMethod.gif)| [GetAllControls](topic7691.md)| Gets collection of all child controls contained by the control. Including the control children's children.   
...
![Public Method](dotnetimages/publicMethod.gif)| [IsValidChild](topic7692.md)| Validates whether the specified control can be added as a child.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDeleted](topic7693.md)| Overridden. Raises the [ControlBase.Deleted](topic7759.md) event.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic7715.md)| Raises the [ControlBase.OnValueChanged](topic7715.md) event. (Inherited from [DriveWorks.Forms.ControlBase](topic7698.md))  
...
![Protected Method](dotnetimages/protectedMethod.gif)| [SerializeCore](topic7694.md)| Overridden. Overridden to serialize child controls.   
