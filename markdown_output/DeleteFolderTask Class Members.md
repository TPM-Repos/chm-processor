...
---|---  
DeleteFolderTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12143.md)  
...
The following tables list the members exposed by [DeleteFolderTask](topic12143.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Path](topic12150.md)| Gets/sets the path to the directory to delete.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Recursive](topic12151.md)| Gets/sets whether to delete the contents of the directory.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12152.md)| Overridden. Gets the class name for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12149.md)| Overridden.   
