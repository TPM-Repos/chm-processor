...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Add](topic4149.md)| Adds a new project component set.   
![Public Method](dotnetimages/publicMethod.gif)| CreateObjRef|  (Inherited from System.MarshalByRefObject)  
![Public Method](dotnetimages/publicMethod.gif)| [Find](topic4150.md)| Finds a component set with the given name.   
![Public Method](dotnetimages/publicMethod.gif)| [GetEnumerator](topic4151.md)| Gets an enumerator which can enumerate over the collection.   
![Public Method](dotnetimages/publicMethod.gif)| GetLifetimeService|  (Inherited from System.MarshalByRefObject)  
![Public Method](dotnetimages/publicMethod.gif)| [Insert](topic4152.md)| Inserts a new project component set at the specified index.   
![Public Method](dotnetimages/publicMethod.gif)| [Move](topic4153.md)| Moves the component set at the given index to the specified new index.   
![Public Method](dotnetimages/publicMethod.gif)| [Remove](topic4154.md)| Removes the given component set.   
![Public Method](dotnetimages/publicMethod.gif)| [RemoveAt](topic4155.md)| Removes the component set at the given index.   
Top
