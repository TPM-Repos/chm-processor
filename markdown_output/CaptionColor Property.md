...
---|---  
    ...
    Public Property CaptionColor As [SimpleColor](topic8856.md)  
...
---|---  
    ...
     
    instance.CaptionColor = value
     
    value = instance.CaptionColor  
  
C#|   
---|---  
      
    
    public [SimpleColor](topic8856.md) CaptionColor {get; set;}  
