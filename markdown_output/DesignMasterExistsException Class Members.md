...
---|---  
DesignMasterExistsException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2675.md)  
...
The following tables list the members exposed by [DesignMasterExistsException](topic2675.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [DesignMasterExistsException Constructor](topic2681.md)| Overloaded.   
Top
