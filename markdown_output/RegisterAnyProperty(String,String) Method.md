...
---|---  
RegisterAnyProperty(String,String) Method   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic10913.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification Namespace](topic10764.md) > [FlowProperties Class](topic10905.md) > [RegisterAnyProperty Method](topic10911.md) : RegisterAnyProperty(String,String) Method  
---  
...
---|---  
    ...
     
    value = instance.RegisterAnyProperty(name, description)  
