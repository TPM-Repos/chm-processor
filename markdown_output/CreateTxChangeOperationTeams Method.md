...
---|---  
CreateTxChangeOperationTeams Method   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12983.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Transactions Namespace](topic12835.md) > [ProjectTransactionFactory Class](topic12928.md) : CreateTxChangeOperationTeams Method  
---  
...
Creates a transaction which, when committed, will update an operation's teams list and properties 
...
---|---  
    ...
    Public Function CreateTxChangeOperationTeams( _
...
---|---  
    ...
     
    value = instance.CreateTxChangeOperationTeams(operation, newTeams, isCreatorPermitted, isOwnerPermitted, isUniversal)  
  
C#|   
---|---  
      
    
    public [ITransaction](topic12837.md) CreateTxChangeOperationTeams( 
