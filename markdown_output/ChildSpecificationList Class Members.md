...
---|---  
ChildSpecificationList Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7547.md)  
...
The following tables list the members exposed by [ChildSpecificationList](topic7547.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [ChildSpecificationList Constructor](topic7553.md)| Initializes a new instance of the [ChildSpecificationList](topic7547.md) type.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [Behavior](topic7566.md)| Gets/sets the behavior of the child specification list.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ColumnWidths](topic7567.md)| Gets/sets the width of the columns.   
![Public Property](dotnetimages/publicProperty.gif)| [Definition](topic7568.md)| Gets the current definition for this item list.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HeaderColor](topic7569.md)| Gets/sets the color used for header items.   
![Public Property](dotnetimages/publicProperty.gif)| [HeaderFont](topic7570.md)| Gets/sets the font used for header items.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HiddenResultColumns](topic7571.md)| Gets/sets the result columns to be hidden from the child specification list.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ListColor](topic7572.md)| Gets/sets the color used for list items.   
![Public Property](dotnetimages/publicProperty.gif)| [ListFont](topic7573.md)| Gets/sets the font used for list items.   
...
![Public Property](dotnetimages/publicProperty.gif)| [NameColumnVisible](topic7574.md)| Gets/sets if the name column is visible or not.   
...
![Public Property](dotnetimages/publicProperty.gif)| [SelectedContext](topic7575.md)| Gets the specification context for the selected item.   
![Public Property](dotnetimages/publicProperty.gif)| [SelectedIndex](topic7576.md)| Gets/sets the selected item by its index.   
![Public Property](dotnetimages/publicProperty.gif)| [SelectedItem](topic7577.md)| Gets the selected item.   
![Public Property](dotnetimages/publicProperty.gif)| [ShowFillerColumn](topic7578.md)| Gets/sets a filler column at the end of each row to fill the remaining control width. If set to FALSE, the final column of data will expand to fill the remaining control width, regardless of a column width specified.   
![Public Property](dotnetimages/publicProperty.gif)| [StateColumnVisible](topic7579.md)| Gets/sets if the state column is visible or not.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TypeColumnVisible](topic7580.md)| Gets/sets if the type column is visible or not.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [AddNewItem](topic7555.md)| Creates a new child specification context.   
...
![Public Method](dotnetimages/publicMethod.gif)| [Dispose](topic7556.md)| Overloaded.   
![Public Method](dotnetimages/publicMethod.gif)| [GetAvailableChildProjects](topic7559.md)| Gets the available projects that can be used to create child specifications for this definition.   
...
![Public Method](dotnetimages/publicMethod.gif)| [Rename](topic7565.md)| Overridden. Renames the control.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic7560.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDeleted](topic7561.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [OnInitialized](topic7562.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [OnParentDefaultFontChanged](topic7563.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic7564.md)| Overridden.   
...
![Public Event](dotnetimages/publicEvent.gif)| [SelectedIndexChanged](topic7594.md)| Raised when the [SelectedIndex](topic7576.md) property changes.   
![Public Event](dotnetimages/publicEvent.gif)| [SpecificationContextStateChanged](topic7595.md)| Raised when a child specification's state is changed.   
