...
---|---  
StartAutopilotTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12644.md)  
...
The following tables list the members exposed by [StartAutopilotTask](topic12644.md).

# ![](dotnetimages/collapse.gif)Public Properties

| Name| Description  
---|---|---  
![Public Property](dotnetimages/publicProperty.gif)| [AutopilotName](topic12651.md)| Gets/sets the Autopilot name.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12652.md)| Overridden. Gets the class name used when writing to the report.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12650.md)| Overridden.   
