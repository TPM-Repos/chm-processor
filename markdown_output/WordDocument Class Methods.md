...
---|---  
WordDocument Class Methods   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic5885.md)  
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [ClearRanges](topic5891.md)| Removes all bookmarks from the list of ranges to be driven.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetRange](topic5894.md)| Get the rule for a driven bookmark.   
![Public Method](dotnetimages/publicMethod.gif)| [GetRangeNames](topic5895.md)| Gets a list of all the driven ranges names.   
![Public Method](dotnetimages/publicMethod.gif)| [GetRangeValues](topic5896.md)| Gets all the ranges resolved values.   
![Public Method](dotnetimages/publicMethod.gif)| [LoadRangesFromFile](topic5899.md)| Matches range information with ranges from file. Creates missing ranges and removes unused ones.   
![Public Method](dotnetimages/publicMethod.gif)| [RangeExists](topic5900.md)| Sees if a given driven bookmark exists with a specific name.   
![Public Method](dotnetimages/publicMethod.gif)| [RemoveRange](topic5901.md)| Removes a bookmark from the list of ranges to be driven.   
![Public Method](dotnetimages/publicMethod.gif)| [SetRange](topic5902.md)| Overloaded. Sets/adds a bookmark to be driven.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [GenerateCore](topic5892.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [GeneratePreviewCore](topic5893.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [InitializeExistingCore](topic5897.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [InitializeNewCore](topic5898.md)| Overridden.   
