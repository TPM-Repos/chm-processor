...
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic4663.md)  
...
The following tables list the members exposed by [ProjectNotFoundException](topic4663.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ProjectNotFoundException Constructor](topic4669.md)| Overloaded.   
Top
