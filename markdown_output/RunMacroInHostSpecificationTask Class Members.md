...
---|---  
RunMacroInHostSpecificationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12536.md)  
...
The following tables list the members exposed by [RunMacroInHostSpecificationTask](topic12536.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [RunMacroInHostSpecificationTask Constructor](topic12542.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [MacroArgumentProperty](topic12545.md)| The property that controls the arguemnts to pass to the macro.   
![Public Property](dotnetimages/publicProperty.gif)| [MacroNameProperty](topic12546.md)| The property for the name of the macro to execute in the host specification.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12547.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12543.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12544.md)| Overridden. Determines whether the task requires the specification context to be open.   
