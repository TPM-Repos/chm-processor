...
---|---  
CopyRequested Event   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11250.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification Namespace](topic10764.md) > [SpecificationContext Class](topic11149.md) : CopyRequested Event  
---  
...
---|---  
    ...
    Public Event CopyRequested As EventHandler(Of SpecificationDetailsEventArgs)  
...
---|---  
    ...
     
    AddHandler instance.CopyRequested, handler  
  
C#|   
---|---  
      
    
    public event EventHandler<SpecificationDetailsEventArgs> CopyRequested  
