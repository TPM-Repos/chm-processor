...
The key identifying the collection of [DriveWorks.Components.Tasks.ComponentTask](topic6407.md)s that should execute on all components. 
...
---|---  
    ...
    Dim value As String
     
    value = [GenerationTaskTypeKeys](topic13743.md).ALL  
