...
---|---  
CommandInvocationException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic681.md)  
...
The following tables list the members exposed by [CommandInvocationException](topic681.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [CommandInvocationException Constructor](topic687.md)| Overloaded.   
Top
