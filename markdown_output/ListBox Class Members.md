...
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8267.md)  
...
The following tables list the members exposed by [ListBox](topic8267.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [ListBox Constructor](topic8273.md)| Initializes a new instance of the [ListBox](topic8267.md) type.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [HasInputValue](topic8281.md)| Overridden. Returns true if the current control has an input value. A control's input value is the main property of the control, editable through the control's interface.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ListBackgroundColor](topic8282.md)| Gets/sets the background color of the list.   
![Public Property](dotnetimages/publicProperty.gif)| [ListBorderColor](topic8283.md)| Gets/sets the border color of the list.   
![Public Property](dotnetimages/publicProperty.gif)| [ListBorderRadius](topic8284.md)| Gets/sets the border radius of the list.   
![Public Property](dotnetimages/publicProperty.gif)| [ListBorderWidth](topic8285.md)| Gets/sets the border width of the list.   
![Public Property](dotnetimages/publicProperty.gif)| [ListColor](topic8286.md)| Gets/sets the text color of list items.   
![Public Property](dotnetimages/publicProperty.gif)| [ListColorDisabled](topic8287.md)| Gets/sets the text color of list items when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [ListColorHover](topic8288.md)| Gets/sets the text color of list items when hovered.   
![Public Property](dotnetimages/publicProperty.gif)| [ListColorSelected](topic8289.md)| Gets/sets the text color of list items when selected.   
![Public Property](dotnetimages/publicProperty.gif)| [ListFont](topic8290.md)| Gets/sets the font used for list items.   
![Public Property](dotnetimages/publicProperty.gif)| [ListItemBackgroundColorHover](topic8291.md)| Gets/sets the background color of list items when hovered.   
![Public Property](dotnetimages/publicProperty.gif)| [ListItemBackgroundColorSelected](topic8292.md)| Gets/sets the background color of list items when selected.   
![Public Property](dotnetimages/publicProperty.gif)| [ListItemBorderColorHover](topic8293.md)| Gets/sets the border color of list items when hovered.   
![Public Property](dotnetimages/publicProperty.gif)| [ListItemBorderColorSelected](topic8294.md)| Gets/sets the border color of list items when selected.   
![Public Property](dotnetimages/publicProperty.gif)| [ListItemBorderRadius](topic8295.md)| Gets/sets the border radius of list items.   
![Public Property](dotnetimages/publicProperty.gif)| [ListItemOutlineColorFocus](topic8296.md)| Gets/sets the outline color of list items when focused.   
![Public Property](dotnetimages/publicProperty.gif)| [ListOpacityDisabled](topic8297.md)| Gets/sets the opacity of the list when the control is disabled.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [ClearInputValue](topic8274.md)| Overridden. Sets the selected item to null.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetInputValue](topic8275.md)| Overridden. Returns the current selected item of the control.   
...
![Public Method](dotnetimages/publicMethod.gif)| [SetInputValue](topic8279.md)| Overloaded. Overridden. Sets the selected item of the control.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic8276.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnParentDefaultFontChanged](topic8277.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic8278.md)| Overridden.   
