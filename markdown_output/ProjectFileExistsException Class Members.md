...
---|---  
ProjectFileExistsException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic4460.md)  
...
The following tables list the members exposed by [ProjectFileExistsException](topic4460.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ProjectFileExistsException Constructor](topic4466.md)| Overloaded.   
Top
