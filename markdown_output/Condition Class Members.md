...
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic10804.md)  
...
The following tables list the members exposed by [Condition](topic10804.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [FailBehavior](topic10815.md)| Gets/sets the fail behavior of the condition.   
![Public Property](dotnetimages/publicProperty.gif)| [FailedOutput](topic10816.md)| The output that gets fulfilled when this condition does not pass.   
![Public Property](dotnetimages/publicProperty.gif)| [Flow](topic10817.md)| Overridden. Gets the flow this node is associated with.   
![Public Property](dotnetimages/publicProperty.gif)| [IsDeleted](topic10818.md)| Determines whether the condition has been deleted.   
![Public Property](dotnetimages/publicProperty.gif)| [Left](topic10819.md)| Overridden. Gets the left position of this condition.   
![Public Property](dotnetimages/publicProperty.gif)| [NavigationInput](topic10820.md)| Overridden. Gets the navigation input of this node.   
![Public Property](dotnetimages/publicProperty.gif)| [NavigationOutput](topic10821.md)| Overridden. Gets the navigation output of this node.   
![Public Property](dotnetimages/publicProperty.gif)| [Negated](topic10822.md)| Determins whether the condition evaluation is to be negated (have not applied to it).   
![Public Property](dotnetimages/publicProperty.gif)| [Outputs](topic10823.md)| Overridden. Gets a collection of all outputs of this node.   
![Public Property](dotnetimages/publicProperty.gif)| [PassedOutput](topic10824.md)| The output that gets fulfilled when this condition passes.   
![Public Property](dotnetimages/publicProperty.gif)| [Properties](topic10825.md)| Overridden. Gets access to the property registration service.   
...
![Public Property](dotnetimages/publicProperty.gif)| [SuppressStandardOutputs](topic10827.md)| Gets whether standard outputs (Passed / Failed) should be suppressed.   
![Public Property](dotnetimages/publicProperty.gif)| [Title](topic10828.md)| Overridden. Gets/sets the human-readable title of the condition.   
![Public Property](dotnetimages/publicProperty.gif)| [Top](topic10829.md)| Overridden. Gets the top position of this condition.   
![Public Property](dotnetimages/publicProperty.gif)| [Width](topic10830.md)| Overridden. Gets/sets the width of the condition.   
Top
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic10826.md)| Overridden. Gets the class name to be written to the report.   
...
![Public Method](dotnetimages/publicMethod.gif)| [Delete](topic10811.md)| Deletes the condition.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetElement](topic10813.md)| Returns a deep copy of this condition's Xml Element.   
...
![Public Method](dotnetimages/publicMethod.gif)| [TryGetOutputEndpoint](topic10814.md)| Overridden. Attempts to retrieve the end point with the given name.   
Top
...
| Name| Description  
---|---|---  
![Protected Method](dotnetimages/protectedMethod.gif)| [AssertNotDeleted](topic10810.md)| Throws an instance of the [DriveWorks.ItemDeletedException](topic3549.md) if the item has been deleted.   
![Protected Method](dotnetimages/protectedMethod.gif)| [DeleteCore](topic10812.md)| Performs any clean-up required when overridden by a derived class.   
...
| Name| Description  
---|---|---  
![Public Event](dotnetimages/publicEvent.gif)| [Deleted](topic10831.md)| Occurs when the condition is deleted.   
