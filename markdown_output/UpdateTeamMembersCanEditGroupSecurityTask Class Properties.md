...
---|---  
UpdateTeamMembersCanEditGroupSecurityTask Class Properties   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12771.md)  
...
For a list of all members of this type, see [UpdateTeamMembersCanEditGroupSecurityTask members](topic12772.md).
