...
---|---  
DeleteSpecificationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12177.md)  
...
The following tables list the members exposed by [DeleteSpecificationTask](topic12177.md).
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12183.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [GetConfirmationMessage](topic12184.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsDeleteContextTask](topic12185.md)| Overridden.   
