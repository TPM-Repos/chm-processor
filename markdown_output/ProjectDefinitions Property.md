...
Gets the definition of each project which can provide the basis of a child specification for the child specification definition. 
...
---|---  
    ...
    Public ReadOnly Property ProjectDefinitions As [ProjectChildSpecificationProjectDef()](topic4067.md)  
...
---|---  
    ...
     
    value = instance.ProjectDefinitions  
  
C#|   
---|---  
      
    
    public [ProjectChildSpecificationProjectDef[]](topic4067.md) ProjectDefinitions {get;}  
