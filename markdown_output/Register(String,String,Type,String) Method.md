...
---|---  
Register(String,String,Type,String) Method   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7107.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.EventFlow Namespace](topic6871.md) > [NodeOutputCollection Class](topic7087.md) > [Register Method](topic7105.md) : Register(String,String,Type,String) Method  
---  
...
---|---  
    ...
     
    value = instance.Register(name, description, valueType, displayName)  
