...
---|---  
ISolidWorksOperationBatch Interface   
[Members](topic1756.md)   
...
Represents a model generation batch being coordinated by the [ISolidWorksHealthMonitor](topic1741.md). 
...
---|---  
    ...
    Public Interface ISolidWorksOperationBatch   
