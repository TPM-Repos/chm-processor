...
---|---  
[GetComponentReferences(ComponentHandle)](topic13397.md)| Gets all components that hold references to the given component.   
[GetComponentReferences(ComponentHandle,Boolean)](topic13398.md)| Gets all components that hold references to the given component.   
