...
Protected Method| [Execute](topic12472.md)| Overridden. Overridden to implement the logic required to release one or more documents.   
...
Protected Method| [IsRunningRequired](topic12473.md)| Overridden. Overridden to indicate that a running specification is required by the task to execute.   
