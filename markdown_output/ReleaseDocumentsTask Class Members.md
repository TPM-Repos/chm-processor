...
---|---  
ReleaseDocumentsTask Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12466.md)  
...
The following tables list the members exposed by [ReleaseDocumentsTask](topic12466.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Documents](topic12474.md)| Gets/sets the identifiers of the documents to release, where "*" is a special identifier meaning all documents.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12475.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12472.md)| Overridden. Overridden to implement the logic required to release one or more documents.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12473.md)| Overridden. Overridden to indicate that a running specification is required by the task to execute.   
