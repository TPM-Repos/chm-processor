...
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7410.md)  
...
The following tables list the members exposed by [CheckBox](topic7410.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [CheckBox Constructor](topic7416.md)| Initializes a new instance of the [CheckBox](topic7410.md) type.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [CheckAlignment](topic7424.md)| Gets/sets the alignment of the check box with respect to its caption.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckBackgroundColor](topic7425.md)| Gets/sets the background color of the check.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckBackgroundColorChecked](topic7426.md)| Gets/sets the background color of the check when checked.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckBackgroundColorDisabled](topic7427.md)| Gets/sets the background color of the check when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckBorderColor](topic7428.md)| Gets/sets the border color of the check.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckBorderColorChecked](topic7429.md)| Gets/sets the border color of the check when checked.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckBorderColorDisabled](topic7430.md)| Gets/sets the border color of the check when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckBorderRadius](topic7431.md)| Gets/sets the border radius of the check.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckBorderWidth](topic7432.md)| Gets/sets the border width of the check.   
![Public Property](dotnetimages/publicProperty.gif)| [Checked](topic7433.md)| Gets/sets whether the check box control is checked.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckMarkColor](topic7434.md)| Gets/sets the color of the check mark shown when checked.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckMarkColorDisabled](topic7435.md)| Gets/sets the color of the check mark shown when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckOpacityDisabled](topic7436.md)| Gets/sets the opacity of the check when the control is disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [CheckSize](topic7437.md)| Gets/sets the size of the check.   
![Public Property](dotnetimages/publicProperty.gif)| [DefaultValue](topic7438.md)| Gets/sets the default value of the control.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HasInputValue](topic7439.md)| Overridden. Returns true if the current control has an input value. A control's input value is the main property of the control, editable through the control's interface.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MacroArgument](topic7440.md)| Gets/sets the argument for the macro that is invoked when this control value changes.   
...
![Public Property](dotnetimages/publicProperty.gif)| [OnChange](topic7441.md)| Gets/sets the name of the macro to run when the value of this control changes.   
...
![Public Property](dotnetimages/publicProperty.gif)| [PictureChecked](topic7442.md)| Gets/sets the picture location to use as the image for this check box when it is not checked.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureDefault](topic7443.md)| Gets/sets the default location for the picture to use as the image for this check box when it is not checked.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureHover](topic7444.md)| Gets/sets the location of the picture to use as the image for this checkbox when it's in a hover state.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureSizeMode](topic7445.md)| Gets/sets the picture sizing mode for this check box.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureStyle](topic7446.md)| Gets/sets the picture appearance style for this check box.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ShowCheck](topic7447.md)| Gets/sets whether the check box part of the control should be shown.   
...
![Public Property](dotnetimages/publicProperty.gif)| [VerticalAlignment](topic7448.md)| Gets/sets the vertical alignment of the control.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [ClearInputValue](topic7417.md)| Overridden. Sets the checked state to false.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetInputValue](topic7418.md)| Overridden. Returns the current checked state of the control.   
...
![Public Method](dotnetimages/publicMethod.gif)| [SetCheckedValue](topic7421.md)| Sets the [CheckBox](topic7410.md)'s [CheckedSourceProperty](topic7459.md) and temporarily registers the source of this change.   
![Public Method](dotnetimages/publicMethod.gif)| [SetInputValue](topic7422.md)| Overloaded. Overridden. Sets the checked state of the control.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic7419.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic7420.md)| Overridden.   
