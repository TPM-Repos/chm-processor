...
---|---  
PictureBox Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8686.md)  
...
The following tables list the members exposed by [PictureBox](topic8686.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [PictureBox Constructor](topic8692.md)| Initializes a new instance of the [PictureBox](topic8686.md) type.   
Top
...
| Name| Description  
---|---|---  
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [BorderColorProperty](topic8701.md)| Provides the property store for the [BorderColor](topic8693.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [BorderRadiusHoverProperty](topic8702.md)| Provides the property store for the [BorderRadiusHover](topic8695.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [BorderRadiusProperty](topic8703.md)| Provides the property store for the [BorderRadius](topic8694.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [BorderStyleProperty](topic8704.md)| Provides the property store for the [BorderStyle](topic8696.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [BorderWidthProperty](topic8705.md)| Provides the property store for the [BorderWidth](topic8697.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [FileNameProperty](topic8706.md)| Provides the property store for the [FileName](topic8698.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [HoverFileNameProperty](topic8707.md)| Provides the property store for the [HoverFileName](topic8699.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [SizeModeProperty](topic8708.md)| Provides the property store for the [SizeMode](topic8700.md) property.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [BorderColor](topic8693.md)| Gets/sets the color of the border around the picture box.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderRadius](topic8694.md)| Gets/sets the border radius of the picture box.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderRadiusHover](topic8695.md)| Gets/sets the border radius of the picture box when hovered.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderStyle](topic8696.md)| Gets/sets the style of the border around the picture box.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderWidth](topic8697.md)| Gets/sets the width of the border around the picture box.   
...
![Public Property](dotnetimages/publicProperty.gif)| [FileName](topic8698.md)| Gets/sets the file name of the picture to be shown.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HoverFileName](topic8699.md)| Gets/sets the hover file name of the picture to be shown.   
...
![Public Property](dotnetimages/publicProperty.gif)| [SizeMode](topic8700.md)| Gets/sets the sizing mode of the picture in the picture box.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic7710.md)| Called when the DataProvider for this control has been initialized. (Inherited from [DriveWorks.Forms.ControlBase](topic7698.md))  
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic7715.md)| Raises the [OnValueChanged](topic7715.md) event. (Inherited from [DriveWorks.Forms.ControlBase](topic7698.md))  
