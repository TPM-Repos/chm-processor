...
---|---  
    ...
    Public Function GetEnumerator() As IEnumerator(Of ProjectSolidWorksComponent)  
...
---|---  
    ...
    Dim value As IEnumerator(Of ProjectSolidWorksComponent)
     
...
---|---  
    ...
    public IEnumerator<ProjectSolidWorksComponent> GetEnumerator()  
