...
---|---  
ItemDeletedException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic3549.md)  
...
The following tables list the members exposed by [ItemDeletedException](topic3549.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ItemDeletedException Constructor](topic3555.md)| Overloaded.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [Message](topic3560.md)| Overridden. Gets a message that describes the error.   
