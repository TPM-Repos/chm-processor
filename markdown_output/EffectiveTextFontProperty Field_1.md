...
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7929.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Forms Namespace](topic7266.md) > [DataTableControl Class](topic7864.md) : EffectiveTextFontProperty Field  
---  
...
---|---  
    ...
     
    value = [DataTableControl](topic7864.md).EffectiveTextFontProperty  
