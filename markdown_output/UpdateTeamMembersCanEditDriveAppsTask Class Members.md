...
---|---  
UpdateTeamMembersCanEditDriveAppsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12762.md)  
...
The following tables list the members exposed by [UpdateTeamMembersCanEditDriveAppsTask](topic12762.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [UpdateTeamMembersCanEditDriveAppsTask Constructor](topic12768.md)|   
Top
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12770.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12769.md)| Overridden.   
