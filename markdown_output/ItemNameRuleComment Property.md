...
Gets/sets a comment for the rule which defines the name assigned to an item derived from the item type. 
...
---|---  
    ...
    Public Property ItemNameRuleComment As String  
...
---|---  
    ...
    Dim value As String
     
    instance.ItemNameRuleComment = value
     
    value = instance.ItemNameRuleComment  
  
C#|   
---|---  
      
    
    public string ItemNameRuleComment {get; set;}  
