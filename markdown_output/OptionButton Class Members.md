...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [ClearInputValue](topic8556.md)| Overridden. Clears the selection of the current control's option group.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetInputValue](topic8557.md)| Overridden. Returns the current selection of the current control's option group.   
...
![Public Method](dotnetimages/publicMethod.gif)| [SetInputValue](topic8560.md)| Overloaded. Overridden. Sets the selection of the current control's option group.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDeleted](topic8558.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [OnInitialized](topic8559.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic7398.md)|  (Inherited from [DriveWorks.Forms.CaptionControlBase](topic7390.md))  
