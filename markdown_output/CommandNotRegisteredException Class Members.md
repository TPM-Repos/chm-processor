...
---|---  
CommandNotRegisteredException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic709.md)  
...
The following tables list the members exposed by [CommandNotRegisteredException](topic709.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [CommandNotRegisteredException Constructor](topic715.md)| Overloaded.   
Top
