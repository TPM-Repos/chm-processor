...
---|---  
ComponentTaskConditionAttribute Constructor(String,String,String,String,ComponentTaskSequenceLocation)   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic6523.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Components.Tasks Namespace](topic6391.md) > [ComponentTaskConditionAttribute Class](topic6512.md) > [ComponentTaskConditionAttribute Constructor](topic6518.md) : ComponentTaskConditionAttribute Constructor(String,String,String,String,ComponentTaskSequenceLocation)  
---  
...
---|---  
    ...
     
    Dim instance As New [ComponentTaskConditionAttribute](topic6512.md)(title, description, image, category, locations)  
