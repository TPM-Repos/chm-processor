...
---|---  
ProjectPermissionException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic4672.md)  
...
The following tables list the members exposed by [ProjectPermissionException](topic4672.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ProjectPermissionException Constructor](topic4678.md)| Overloaded.   
Top
