...
---|---  
InvalidTemplateException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic860.md)  
...
The following tables list the members exposed by [InvalidTemplateException](topic860.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [InvalidTemplateException Constructor](topic866.md)| Creates a new instance of the [InvalidTemplateException](topic860.md) class.   
Top
