...
Provides the property store for the [UnitPadding](topic8425.md) property. 
...
---|---  
    ...
    Public Shared ReadOnly UnitPaddingProperty As [DynamicProperty](topic9398.md)  
...
---|---  
    ...
     
    value = [MeasurementTextBox](topic8364.md).UnitPaddingProperty  
  
C#|   
---|---  
      
    
    public static readonly [DynamicProperty](topic9398.md) UnitPaddingProperty  
