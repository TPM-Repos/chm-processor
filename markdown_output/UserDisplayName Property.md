...
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification.StandardTasks Namespace](topic11896.md) > [AddUserTask Class](topic11914.md) : UserDisplayName Property  
---  
...
---|---  
    ...
    Dim value As String
     
    instance.UserDisplayName = value
     
