...
| Name| Description  
---|---|---  
Public Method| [BeginAdd](topic8190.md)| Overloaded. Starts the adding process for this item list. Informs the specification context that a dialog is being opened etc.   
Public Method| [BeginCopy](topic8193.md)| Overloaded. Starts the copying process for this item list. Informs the specification context that a dialog is being opened etc.   
Public Method| [BeginEdit](topic8196.md)| Overloaded. Starts the editing process for this item list. Informs the specification context that a dialog is being opened etc.   
...
Public Method| [Delete](topic8199.md)| Removes the item at the specified index. This works off of the [Selected Index](topic8217.md) property.   
...
Public Method| [MoveItemDown](topic8200.md)| Invokes the move item down command. This works off of the [Selected Index](topic8217.md) property.   
Public Method| [MoveItemUp](topic8201.md)| Invokes the move item up command. This works off of the [Selected Index](topic8217.md) property.   
Public Method| [Rename](topic8207.md)| Overridden. Renames the control.   
...
Protected Method| [OnDataProviderInitialized](topic8202.md)| Overridden.   
Protected Method| [OnDeleted](topic8203.md)| Overridden.   
Protected Method| [OnInitialized](topic8204.md)| Overridden.   
Protected Method| [OnParentDefaultFontChanged](topic8205.md)| Overridden.   
...
Protected Method| [OnValueChanged](topic8206.md)| Overridden.   
