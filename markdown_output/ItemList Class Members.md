...
---|---  
ItemList Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8183.md)  
...
The following tables list the members exposed by [ItemList](topic8183.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [ItemList Constructor](topic8189.md)| Initializes a new instance of the [ItemList](topic8183.md) type.   
Top
...
| Name| Description  
---|---|---  
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [ColumnWidthsProperty](topic8221.md)| Provides the property store for the [ColumnWidths](topic8208.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [EffectiveHeaderFontProperty](topic8222.md)| Provides the property store for the effective list font.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [EffectiveListFontProperty](topic8223.md)| Provides the property store for the effective list font.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [HeaderColorProperty](topic8224.md)| Provides the property store for the [HeaderColor](topic8210.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [HeaderFontProperty](topic8225.md)| Provides the property store for the [HeaderFont](topic8211.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [HiddenItemValuesProperty](topic8226.md)| Provides the property store for the [HiddenItemValues](topic8212.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [ItemsProperty](topic8227.md)| Provides the property store for the [Items](topic8213.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [ListColorProperty](topic8228.md)| Provides the property store for the [ListColor](topic8214.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [ListFontProperty](topic8229.md)| Provides the property store for the [ListFont](topic8215.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [NameColumnVisibleProperty](topic8230.md)| Provides the property store for the [NameColumnVisible](topic8216.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [ShowFillerColumnProperty](topic8231.md)| Provides the property store for the [ShowFillerColumn](topic8218.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TaskListEnabledProperty](topic8232.md)| Provides the property store for the [TaskListEnabled](topic8219.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [TypeColumnVisibleProperty](topic8233.md)| Provides the property store for the [TypeColumnVisible](topic8220.md) property.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [ColumnWidths](topic8208.md)| Gets/sets the width of the columns.   
![Public Property](dotnetimages/publicProperty.gif)| [Definition](topic8209.md)| Gets the current definition for this item list.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HeaderColor](topic8210.md)| Gets/sets the color used for header items.   
![Public Property](dotnetimages/publicProperty.gif)| [HeaderFont](topic8211.md)| Gets/sets the font used for header items.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HiddenItemValues](topic8212.md)| Gets/sets the item values to be hidden from the Item List.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Items](topic8213.md)| Gets/sets the names of the dialogs which can create items.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ListColor](topic8214.md)| Gets/sets the color used for list items.   
![Public Property](dotnetimages/publicProperty.gif)| [ListFont](topic8215.md)| Gets/sets the font used for list items.   
...
![Public Property](dotnetimages/publicProperty.gif)| [NameColumnVisible](topic8216.md)| Gets/sets if the Name column is visible or not.   
...
![Public Property](dotnetimages/publicProperty.gif)| [SelectedIndex](topic8217.md)| Gets/sets the selected item by its index   
![Public Property](dotnetimages/publicProperty.gif)| [ShowFillerColumn](topic8218.md)| Gets/sets a filler column at the end of each row to fill the remaining control width. If set to FALSE, the final column of data will expand to fill the remaining control width, regardless of a column width specified.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TaskListEnabled](topic8219.md)| Gets/sets whether the dialog task list should be enabled.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TypeColumnVisible](topic8220.md)| Gets/sets if the type column is visible or not.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [BeginAdd](topic8190.md)| Overloaded. Starts the adding process for this item list. Informs the specification context that a dialog is being opened etc.   
![Public Method](dotnetimages/publicMethod.gif)| [BeginCopy](topic8193.md)| Overloaded. Starts the copying process for this item list. Informs the specification context that a dialog is being opened etc.   
![Public Method](dotnetimages/publicMethod.gif)| [BeginEdit](topic8196.md)| Overloaded. Starts the editing process for this item list. Informs the specification context that a dialog is being opened etc.   
...
![Public Method](dotnetimages/publicMethod.gif)| [Delete](topic8199.md)| Removes the item at the specified index. This works off of the [Selected Index](topic8217.md) property.   
...
![Public Method](dotnetimages/publicMethod.gif)| [MoveItemDown](topic8200.md)| Invokes the move item down command. This works off of the [Selected Index](topic8217.md) property.   
![Public Method](dotnetimages/publicMethod.gif)| [MoveItemUp](topic8201.md)| Invokes the move item up command. This works off of the [Selected Index](topic8217.md) property.   
![Public Method](dotnetimages/publicMethod.gif)| [Rename](topic8207.md)| Overridden. Renames the control.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic8202.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDeleted](topic8203.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [OnInitialized](topic8204.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [OnParentDefaultFontChanged](topic8205.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic8206.md)| Overridden.   
...
![Public Event](dotnetimages/publicEvent.gif)| [SelectedIndexChanged](topic8234.md)| Raised when the [SelectedIndex](topic8217.md) property changes.   
