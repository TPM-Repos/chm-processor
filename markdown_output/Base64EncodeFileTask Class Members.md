...
---|---  
Base64EncodeFileTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11950.md)  
...
The following tables list the members exposed by [Base64EncodeFileTask](topic11950.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [Base64EncodeFileTask Constructor](topic11956.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [ConstantName](topic11958.md)| Gets/sets the flow property that is control of the name of the constant to drive the value into.   
...
![Public Property](dotnetimages/publicProperty.gif)| [FilePath](topic11959.md)| Gets/sets the path to the file to be encoded.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic11960.md)| Overridden. Gets the class name used when writing to the report.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic11957.md)| Overridden.   
