...
---|---  
Apply(FlowProperty) Method   
  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Transactions Namespace](topic12835.md) > [FlowPropertyData Class](topic12873.md) > [Apply Method](topic12882.md) : Apply(FlowProperty) Method  
---  
