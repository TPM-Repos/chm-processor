...
---|---  
InitialStateInvalidException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11018.md)  
...
The following tables list the members exposed by [InitialStateInvalidException](topic11018.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [InitialStateInvalidException Constructor](topic11024.md)| Overloaded.   
Top
