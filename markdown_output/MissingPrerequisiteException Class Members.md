...
---|---  
MissingPrerequisiteException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic3725.md)  
...
The following tables list the members exposed by [MissingPrerequisiteException](topic3725.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [MissingPrerequisiteException Constructor](topic3731.md)| Overloaded.   
Top
