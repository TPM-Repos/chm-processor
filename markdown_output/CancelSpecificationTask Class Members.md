...
---|---  
CancelSpecificationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11971.md)  
...
The following tables list the members exposed by [CancelSpecificationTask](topic11971.md).
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic11978.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic11977.md)| Overridden.   
...
[CancelSpecificationTask Class](topic11971.md)   
