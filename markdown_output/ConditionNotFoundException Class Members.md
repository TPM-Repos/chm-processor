...
---|---  
ConditionNotFoundException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic10854.md)  
...
The following tables list the members exposed by [ConditionNotFoundException](topic10854.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ConditionNotFoundException Constructor](topic10860.md)| Overloaded.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [TypeName](topic10864.md)| Gets the type name of the condition for which an implementation could not be found.   
Top
...
![Public Method](dotnetimages/publicMethod.gif)| [GetObjectData](topic10863.md)| Overridden.   
