...
The invariant name of the Layers view. 
...
---|---  
    ...
    Public Const LayersView As String  
...
---|---  
    ...
    Dim value As String
     
    value = [DriveWorksCaptureViewNames](topic13545.md).LayersView  
  
C#|   
---|---  
      
    
    public const string LayersView  
