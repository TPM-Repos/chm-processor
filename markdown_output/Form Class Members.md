...
![Public Method](dotnetimages/publicMethod.gif)| [DeleteControls](topic8092.md)| Overloaded. Deletes the specified control from the form.   
![Public Method](dotnetimages/publicMethod.gif)| [GetAllControls](topic7691.md)| Gets collection of all child controls contained by the control. Including the control children's children. (Inherited from [DriveWorks.Forms.ContainerControlBase](topic7684.md))  
...
![Public Method](dotnetimages/publicMethod.gif)| [IsValidChild](topic7692.md)| Validates whether the specified control can be added as a child. (Inherited from [DriveWorks.Forms.ContainerControlBase](topic7684.md))  
![Public Method](dotnetimages/publicMethod.gif)| [IsValidParent](topic8095.md)| Overridden. Overridden to prevent parenting the form to any other control.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDeleted](topic7693.md)| Raises the [Deleted](topic7759.md) event. (Inherited from [DriveWorks.Forms.ContainerControlBase](topic7684.md))  
...
![Protected Method](dotnetimages/protectedMethod.gif)| [SerializeCore](topic7694.md)| Overridden to serialize child controls. (Inherited from [DriveWorks.Forms.ContainerControlBase](topic7684.md))  
