...
---|---  
FrameControl Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8112.md)  
...
The following tables list the members exposed by [FrameControl](topic8112.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [FormName](topic8119.md)| Gets/sets the form to display inline.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HorizontalScrollBarVisibility](topic8120.md)| Gets/sets the horizontal visibility of the scroll bar for the frame's content.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MainProperty](topic8121.md)|   
...
![Public Property](dotnetimages/publicProperty.gif)| [VerticalScrollBarVisibility](topic8122.md)| Gets/sets the vertical visibility of the scroll bar for the frame's content.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetForm](topic8118.md)| Gets the an instance of a form that matches the [FormName](topic8119.md) property.   
