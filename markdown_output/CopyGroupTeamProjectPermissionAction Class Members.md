...
---|---  
CopyGroupTeamProjectPermissionAction Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9826.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.GroupMaintenance Namespace](topic9628.md) : CopyGroupTeamProjectPermissionAction Class  
---  
...
The following tables list the members exposed by [CopyGroupTeamProjectPermissionAction](topic9826.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Status](topic9834.md)| The current status of the action.   
![Public Property](dotnetimages/publicProperty.gif)| [StatusMessage](topic9835.md)| Overridden. The current human readable status of this action.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Execute](topic9832.md)| Overridden. Executes this action.   
![Public Method](dotnetimages/publicMethod.gif)| [GetCanExecute](topic9833.md)| Overridden. Checks to see if the action can be executed or not.   
Top
