...
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8626.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Forms Namespace](topic7266.md) > [OptionGroup Class](topic8608.md) : MaximumRows Property  
---  
...
---|---  
    ...
    Public Property MaximumRows As Double  
...
---|---  
    ...
    public double MaximumRows {get; set;}  
