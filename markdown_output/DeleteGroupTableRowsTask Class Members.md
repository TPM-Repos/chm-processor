...
---|---  
DeleteGroupTableRowsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12153.md)  
...
The following tables list the members exposed by [DeleteGroupTableRowsTask](topic12153.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [DeleteGroupTableRowsTask Constructor](topic12159.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [FieldNames](topic12161.md)| Gets/sets the column names to match against, delimited by pipe bars.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MatchValues](topic12162.md)| Gets/sets the values to match against, based on the fields specified in the [FieldNames](topic12161.md) property. Values should be delimited with pipe bars.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TableName](topic12164.md)| Gets/sets the name of the group table to remove rows from.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12163.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12160.md)| Overridden.   
...
[DeleteGroupTableRowsTask Class](topic12153.md)   
