ReplaceReferenceException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic15291.md)  
...
The following tables list the members exposed by [ReplaceReferenceException](topic15291.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ReplaceReferenceException Constructor](topic15297.md)| Overloaded.   
Top
...
![Public Method](dotnetimages/publicMethod.gif)| [GetObjectData](topic15300.md)| Overridden.   
