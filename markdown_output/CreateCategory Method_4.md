...
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic5348.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks Namespace](topic2159.md) > [SpecificationMacroCategories Class](topic5342.md) : CreateCategory Method  
---  
...
---|---  
    ...
    public [SpecificationMacroCategory](topic5359.md) CreateCategory( 
       string _name_
    )  
