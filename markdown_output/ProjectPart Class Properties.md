...
---|---  
ProjectPart Class Properties   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic14659.md)  
...
For a list of all members of this type, see [ProjectPart members](topic14660.md).
