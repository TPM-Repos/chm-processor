...
---|---  
ConstantValueChanged Event   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic4270.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks Namespace](topic2159.md) > [ProjectConstants Class](topic4246.md) : ConstantValueChanged Event  
---  
...
---|---  
    ...
    Public Event ConstantValueChanged As [ConstantChangedEventHandler](topic5929.md)  
...
---|---  
    ...
     
    AddHandler instance.ConstantValueChanged, handler  
  
C#|   
---|---  
      
    
    public event [ConstantChangedEventHandler](topic5929.md) ConstantValueChanged  
