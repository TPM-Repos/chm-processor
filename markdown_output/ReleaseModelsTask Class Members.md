...
Protected Method| [Execute](topic12495.md)| Overridden. Overridden to implement the logic required to release one or more documents.   
...
Protected Method| [IsRunningRequired](topic12496.md)| Overridden. Overridden to indicate that a running specification is required by the task to execute.   
