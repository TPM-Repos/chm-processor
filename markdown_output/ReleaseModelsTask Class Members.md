...
---|---  
ReleaseModelsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12489.md)  
...
The following tables list the members exposed by [ReleaseModelsTask](topic12489.md).
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12495.md)| Overridden. Overridden to implement the logic required to release one or more documents.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12496.md)| Overridden. Overridden to indicate that a running specification is required by the task to execute.   
