...
---|---  
PreparationFailedException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic15281.md)  
...
The following tables list the members exposed by [PreparationFailedException](topic15281.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [PreparationFailedException Constructor](topic15287.md)| Overloaded.   
Top
