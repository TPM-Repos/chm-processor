SpecificationHostControl Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8979.md)  
...
The following tables list the members exposed by [SpecificationHostControl](topic8979.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [HorizontalScrollVisibility](topic8989.md)| The visibility setting for the hosts horizontal scroll bar.   
![Public Property](dotnetimages/publicProperty.gif)| [HostedContext](topic8990.md)| The current specification context that is being hosted or null.   
![Public Property](dotnetimages/publicProperty.gif)| [InputValues](topic8991.md)| An optional table that has two columns (Name and Value). The values will be driven into the hosted specification based on the name column.   
...
![Public Property](dotnetimages/publicProperty.gif)| [OnCancelledMacroName](topic8992.md)| The name of the macro to execute when the hosted specification is cancelled.   
![Public Property](dotnetimages/publicProperty.gif)| [OnTransitionedMacroName](topic8993.md)| The name of the macro to execute when the hosted specification is transitioned.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Value](topic8994.md)| The resulting value of this control. This will be a table of specification details and specification properties.   
![Public Property](dotnetimages/publicProperty.gif)| [VerticalScrollVisibility](topic8995.md)| The visibility setting for the hosts vertical scroll bar.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Dispose](topic8986.md)|   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnInitialized](topic8987.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic8988.md)| Overridden.   
...
![Public Event](dotnetimages/publicEvent.gif)| [HostedContextChanged](topic9001.md)| Raised when the [HostedContext](topic8990.md) value changes.   
