...
Public Method| [ClearPreview](topic8715.md)| Clears the preview result from memory.   
Public Method| CreateObjRef|  (Inherited from System.MarshalByRefObject)  
Public Method| [CreatePreviewFromServer](topic8717.md)| Creates a preview from the server.   
Public Method| [CreatePreviewFromServerAsync](topic8718.md)| Creates a preview from the server asynchronously.   
Public Method| [CreatePreviewImage](topic8719.md)| Overloaded. Generates a preview screenshot from the preview control   
...
Public Method| [EnterXRSession](topic8722.md)| Enter an XR session.   
...
Public Method| [GetPreview](topic8723.md)| Gets the preview for the control.   
Public Method| [GetPreviewForExport](topic8724.md)| Gets the preview for a form export.   
...
Public Method| [LeaveXRSession](topic8725.md)| Leaves an XR session.   
Public Method| [RaiseLoadingStateChanged](topic8730.md)| Raises the event for the state of the loa ding image changing.   
...
Protected Method| [OnDataProviderInitialized](topic8726.md)| Overridden. Called when the DataProvider for this control has been initialized.   
Protected Method| [OnDeleted](topic8727.md)| Overridden.   
Protected Method| [OnInitialized](topic8728.md)| Overridden. Raises the [Initialized](topic7760.md) event.   
...
Protected Method| [OnValueChanged](topic8729.md)| Overridden.   
