...
---|---  
InvokeChildSpecificationOperationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12317.md)  
...
The following tables list the members exposed by [InvokeChildSpecificationOperationTask](topic12317.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [InvokeChildSpecificationOperationTask Constructor](topic12323.md)|   
Top
...
| Name| Description  
---|---|---  
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecificationListNameProperty](topic12325.md)| Gets the flow property responsible for the name of the child specification list to get the child specification from.   
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecIndexProperty](topic12326.md)| Gets the flow property responsible for the index of the child specification to invoke the operation on.   
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecNameProperty](topic12327.md)| Gets the flow property responsible for the name of the child specification to invoke the operation on.   
...
![Public Property](dotnetimages/publicProperty.gif)| [OperationNameProperty](topic12328.md)| Gets the flow property responsible for the name of the operation to invoke on the child specification.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12329.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12324.md)| Overridden.   
