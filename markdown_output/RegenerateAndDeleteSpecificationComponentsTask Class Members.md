...
---|---  
RegenerateAndDeleteSpecificationComponentsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12436.md)  
...
The following tables list the members exposed by [RegenerateAndDeleteSpecificationComponentsTask](topic12436.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [RegenerateAndDeleteSpecificationComponentsTask Constructor](topic12442.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [SpecificationId](topic12445.md)| Gets/sets the specification id of the specification whose components to delete and mark for regeneration.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12444.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12443.md)| Overridden.   
