...
---|---  
SetStatesToTriggerOnTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12600.md)  
...
The following tables list the members exposed by [SetStatesToTriggerOnTask](topic12600.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [SetStatesToTriggerOnTask Constructor](topic12606.md)|   
Top
...
| Name| Description  
---|---|---  
![Public Property](dotnetimages/publicProperty.gif)| [Append](topic12608.md)| Gets/sets whether to append the new states to trigger on. False if we want to replace the existing states.   
...
![Public Property](dotnetimages/publicProperty.gif)| [NewStatesToTriggerOn](topic12609.md)| Gets/sets the states to trigger on.   
...
![Public Property](dotnetimages/publicProperty.gif)| [SpecificationName](topic12610.md)| Gets/sets the names of the specifications to edit the triggered actions of.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TriggeredActionDocumentName](topic12611.md)| Gets/sets the name of the triggered action document to edit.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12607.md)| Overridden.   
