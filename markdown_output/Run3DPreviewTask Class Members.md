...
---|---  
Run3DPreviewTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12512.md)  
...
The following tables list the members exposed by [Run3DPreviewTask](topic12512.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [Run3DPreviewTask Constructor](topic12518.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [ControlName](topic12521.md)| Gets/sets the flow property that is the name of the control to run the 3d preview on.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12522.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12519.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12520.md)| Overridden.   
