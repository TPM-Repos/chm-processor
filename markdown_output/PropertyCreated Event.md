...
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic4847.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks Namespace](topic2159.md) > [ProjectSpecificationProperties Class](topic4833.md) : PropertyCreated Event  
---  
...
---|---  
    ...
    Public Event PropertyCreated As [ProjectSpecificationPropertyEventHandler](topic5934.md)  
...
---|---  
    ...
     
    AddHandler instance.PropertyCreated, handler  
  
C#|   
---|---  
      
    
    public event [ProjectSpecificationPropertyEventHandler](topic5934.md) PropertyCreated  
