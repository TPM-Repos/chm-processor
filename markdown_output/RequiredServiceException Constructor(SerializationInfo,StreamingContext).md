...
Creates a new instance of the [RequiredServiceException](topic915.md) exception calls from System.Runtime.Serialization.SerializationInfo. 
...
---|---  
    ...
     
    Dim instance As New [RequiredServiceException](topic915.md)(info, context)  
  
C#|   
---|---  
      
    
    protected RequiredServiceException( 
