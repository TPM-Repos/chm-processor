...
---|---  
DesignMasterFormatException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2685.md)  
...
The following tables list the members exposed by [DesignMasterFormatException](topic2685.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [DesignMasterFormatException Constructor](topic2691.md)| Overloaded.   
Top
