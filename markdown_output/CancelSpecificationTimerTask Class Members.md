...
---|---  
CancelSpecificationTimerTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11979.md)  
...
The following tables list the members exposed by [CancelSpecificationTimerTask](topic11979.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [TimerNames](topic11987.md)| Gets/sets the name/s of the Timer/s to cancel.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic11986.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic11985.md)| Overridden.   
