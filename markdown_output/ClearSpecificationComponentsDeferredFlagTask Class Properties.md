...
---|---  
ClearSpecificationComponentsDeferredFlagTask Class Properties   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12010.md)  
...
For a list of all members of this type, see [ClearSpecificationComponentsDeferredFlagTask members](topic12011.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [SpecificationId](topic12019.md)| Gets/sets the id of the specification whose drawings to clear the deferred flag on.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12018.md)| Overridden. Gets the class name used for reporting.   
