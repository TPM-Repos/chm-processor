...
---|---  
ButtonBase Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7338.md)  
...
The following tables list the members exposed by [ButtonBase](topic7338.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [BorderColor](topic7347.md)| Gets/sets the border color for the control.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderColorDisabled](topic7348.md)| Gets/sets the border color for the control when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderColorHover](topic7349.md)| Gets/sets the border color for the control on hover.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderColorPressed](topic7350.md)| Gets/sets the border color for the control when pressed.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderRadius](topic7351.md)| Gets/sets the border radius of the control.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderRadiusHover](topic7352.md)| Gets/sets the border radius of the control when hovered.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderRadiusPressed](topic7353.md)| Gets/sets the border radius of the control when pressed.   
![Public Property](dotnetimages/publicProperty.gif)| [BorderWidth](topic7354.md)| Gets/sets the border width for the control.   
![Public Property](dotnetimages/publicProperty.gif)| [ButtonBackgroundColor](topic7355.md)| Gets/sets the background color of the button.   
![Public Property](dotnetimages/publicProperty.gif)| [ButtonBackgroundColorDisabled](topic7356.md)| Gets/sets the background color of the button when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [ButtonBackgroundColorHover](topic7357.md)| Gets/sets the background color of the button when hovered.   
![Public Property](dotnetimages/publicProperty.gif)| [ButtonBackgroundColorPressed](topic7358.md)| Gets/sets the background color of the button when pressed.   
![Public Property](dotnetimages/publicProperty.gif)| [ButtonOpacityDisabled](topic7359.md)| Gets/sets the opacity of the button when the control is disabled.   
...
![Public Property](dotnetimages/publicProperty.gif)| [OutlineColorFocus](topic7360.md)| Gets/sets the outline color when focused.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Text](topic7361.md)| Gets/sets the text shown in the button.   
![Public Property](dotnetimages/publicProperty.gif)| [TextColor](topic7362.md)| Gets/sets the color used for the button's text.   
![Public Property](dotnetimages/publicProperty.gif)| [TextColorDisabled](topic7363.md)| Gets/sets the color used for the button's text when disabled.   
![Public Property](dotnetimages/publicProperty.gif)| [TextColorHover](topic7364.md)| Gets/sets the color used for the button's text when hovered.   
![Public Property](dotnetimages/publicProperty.gif)| [TextColorPressed](topic7365.md)| Gets/sets the color used for the button's text when pressed.   
![Public Property](dotnetimages/publicProperty.gif)| [TextFont](topic7366.md)| Gets/sets the font used for the button's text.   
![Public Property](dotnetimages/publicProperty.gif)| [TextHorizontalAlignment](topic7367.md)| Gets/Sets the horizontal alignment of text on this button.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnDataProviderInitialized](topic7344.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnParentDefaultFontChanged](topic7345.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [OnValueChanged](topic7346.md)| Overridden.   
