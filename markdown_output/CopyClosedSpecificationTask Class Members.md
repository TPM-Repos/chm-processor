...
---|---  
CopyClosedSpecificationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12048.md)  
...
The following tables list the members exposed by [CopyClosedSpecificationTask](topic12048.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [CopiedSpecificationIdConstantName](topic12056.md)| Gets the property responsible for the name of the constant to place the copied specification's id in.   
...
![Public Property](dotnetimages/publicProperty.gif)| [SpecificationId](topic12058.md)| Gets the property responsible for the specification id to match against.   
![Public Property](dotnetimages/publicProperty.gif)| [SpecificationName](topic12059.md)| Gets the property responsible for the specification name to match against.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12057.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12054.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [RequiresSingleContext](topic12055.md)| Overridden.   
