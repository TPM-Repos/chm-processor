...
---|---  
RegisterInt32Property(String,FlowPropertyInfo) Method   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic10933.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification Namespace](topic10764.md) > [FlowProperties Class](topic10905.md) > [RegisterInt32Property Method](topic10930.md) : RegisterInt32Property(String,FlowPropertyInfo) Method  
---  
...
---|---  
    ...
     
    value = instance.RegisterInt32Property(name, info)  
