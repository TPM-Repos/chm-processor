...
---|---  
MacroButton Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8340.md)  
...
The following tables list the members exposed by [MacroButton](topic8340.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [MacroButton Constructor](topic8346.md)| Initializes a new instance of the [MacroButton](topic8340.md) type.   
Top
...
| Name| Description  
---|---|---  
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [MacroArgumentProperty](topic8357.md)| Provides the property store for the [MacroArgument](topic8350.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [MacroNameProperty](topic8358.md)| Provides the property store for the [MacroName](topic8351.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PictureDefaultProperty](topic8359.md)| Provides the property store for the [PictureDefault](topic8352.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PictureHoverProperty](topic8360.md)| Provides the property store for the [PictureHover](topic8353.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PicturePressedProperty](topic8361.md)| Provides the property store for the [PicturePressed](topic8354.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PictureSizeModeProperty](topic8362.md)| Provides the property store for the [PictureSizeMode](topic8355.md) property.   
![Public Field](dotnetimages/publicField.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [PictureStyleProperty](topic8363.md)| Provides the property store for the [PictureStyle](topic8356.md) property.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [MacroArgument](topic8350.md)| Gets/sets the argument to the macro invoked by the button when it is clicked.   
![Public Property](dotnetimages/publicProperty.gif)| [MacroName](topic8351.md)| Gets/sets the name of the macro invoked by the button when it is clicked.   
...
![Public Property](dotnetimages/publicProperty.gif)| [PictureDefault](topic8352.md)| Gets/sets the location of the default picture to use as the default image for this macro button.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureHover](topic8353.md)| Gets/sets the location of the picture to use as the image for this macro button when it's in a hover state.   
![Public Property](dotnetimages/publicProperty.gif)| [PicturePressed](topic8354.md)| Gets/sets the location of the picture to use as the image for this macro button when it's in a pressed state.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureSizeMode](topic8355.md)| Gets/sets the picture sizing mode for this macro button.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureStyle](topic8356.md)| Gets/sets the picture appearance style for this macro button.   
...
![Public Method](dotnetimages/publicMethod.gif)| [Invoke](topic8347.md)| Overloaded. Invokes the macro specified in the [MacroName](topic8351.md) property.   
