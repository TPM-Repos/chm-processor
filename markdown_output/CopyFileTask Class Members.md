...
---|---  
CopyFileTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12060.md)  
...
The following tables list the members exposed by [CopyFileTask](topic12060.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [DestinationFile](topic12067.md)| Gets/sets the path to which to copy or move the file.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Move](topic12068.md)| Gets/sets whether to move the file (TRUE) or copy it (FALSE).   
...
![Public Property](dotnetimages/publicProperty.gif)| [Overwrite](topic12069.md)| Gets/sets whether to overwrite the destination file if it already exists.   
...
![Public Property](dotnetimages/publicProperty.gif)| [SourceFile](topic12071.md)| Gets/sets the path to the file to be copied or moved.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12070.md)| Overridden. Gets the class name used when writing to the report.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12066.md)| Overridden.   
