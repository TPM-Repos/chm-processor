TinyMCEControl Class Members   
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9204.md)  
...
The following tables list the members exposed by [TinyMCEControl](topic9204.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [ByteLimit](topic9223.md)| Gets/sets the max input limit in bytes.   
![Public Property](dotnetimages/publicProperty.gif)| [CanvasBackgroundColor](topic9224.md)| Gets/sets the color used for the control's text.   
![Public Property](dotnetimages/publicProperty.gif)| [CanvasTextColor](topic9225.md)| Gets/sets the color used for the control's text.   
![Public Property](dotnetimages/publicProperty.gif)| [CharacterLimit](topic9226.md)| Gets/sets the number of characters that can appear in the TextBox.   
![Public Property](dotnetimages/publicProperty.gif)| [DefaultValue](topic9227.md)| Gets/sets the default value of the control.   
![Public Property](dotnetimages/publicProperty.gif)| [DuplicateFileUploadBehavior](topic9228.md)| Gets/sets how duplicate file names will be handled.   
![Public Property](dotnetimages/publicProperty.gif)| [EditorMode](topic9229.md)| Gets/sets the editor mode, either Basic or Advanced   
![Public Property](dotnetimages/publicProperty.gif)| [EffectiveHtml](topic9230.md)| Gets the effective HTML of the TinyMCE Control.   
...
![Public Property](dotnetimages/publicProperty.gif)| [EnableUpload](topic9231.md)| Gets/sets whether the user can upload files (TRUE) or cannot (FALSE)   
![Public Property](dotnetimages/publicProperty.gif)| [FinalUploadedFilePath](topic9232.md)| Gets the resulting file path of the file after saving. Is converted to a resource URL in the adapter, consumed by the client, then reset until the next upload.   
...
![Public Property](dotnetimages/publicProperty.gif)| [HasInputValue](topic9233.md)| Overridden. Returns true if the current control has an input value. A control's input value is the main property of the control, editable through the control's interface.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Html](topic9234.md)| Gets/sets the HTML shown in the TinyMCE Control.   
...
![Public Property](dotnetimages/publicProperty.gif)| [IsUploadRejected](topic9235.md)| Boolean to determine whether to reject the upload promise.   
![Public Property](dotnetimages/publicProperty.gif)| [LanguagePackPath](topic9236.md)| Gets/sets the file name of the language pack to be used.   
...
![Public Property](dotnetimages/publicProperty.gif)| [PlaceholderText](topic9237.md)| Gets/sets the placeholder text to display in the text box when it is empty.   
...
![Public Property](dotnetimages/publicProperty.gif)| [UploadCompleteMacro](topic9238.md)| Gets/sets the name of the macro to call when uploading of a file is complete.   
![Public Property](dotnetimages/publicProperty.gif)| [UploadDirectory](topic9239.md)| Gets/sets the directory path to use for uploaded files.   
![Public Property](dotnetimages/publicProperty.gif)| [UploadDisabledMessage](topic9240.md)| Message text to display when the EnableUpload property is set to FALSE.   
![Public Property](dotnetimages/publicProperty.gif)| [UploadFileExtensionFilter](topic9241.md)| Gets/sets the filter to use when picking a file to upload.   
![Public Property](dotnetimages/publicProperty.gif)| [UploadFileSizeLimit](topic9242.md)| Gets/sets the limit on the size of the file that can be uploaded.   
...
| Name| Description  
---|---|---  
Public Method| [ClearInputValue](topic9210.md)| Overridden. Sets the control's HTML to an empty string.   
...
Public Method| [GetAllowedFileExtensions](topic9211.md)| Gets a list of extensions for the files that are allowed to be uploaded with this control.   
...
Public Method| [GetInputValue](topic9212.md)| Overridden. Returns the HTML value of the control.   
Public Method| GetLifetimeService|  (Inherited from System.MarshalByRefObject)  
Public Method| [HandleUpload](topic9213.md)| Takes the specified inputs and completes the upload process for this control asynchronously.   
...
Public Method| [RejectUpload](topic9216.md)| Sets the IsUploadRejectedProperty to True.   
Public Method| [Rename](topic7717.md)| Renames the control. (Inherited from [DriveWorks.Forms.ControlBase](topic7698.md))  
Public Method| [ResetFinalUploadedFilePath](topic9217.md)| Resets the FinalUploadedFilePathProperty to an empty string.   
Public Method| [ResetIsUploadRejected](topic9218.md)| Resets the IsUploadRejectedProperty back to False (its default state).   
...
Public Method| [SetInputValue](topic9219.md)| Overloaded. Overridden. Sets the HTML value of the control.   
Public Method| [TryGetUploadFileSizeLimitInBytes](topic9221.md)| Returns the value of the [UploadFileSizeLimit](topic9242.md) property converted to bytes.   
...
Protected Method| [OnDataProviderInitialized](topic9214.md)| Overridden.   
...
Protected Method| [OnValueChanged](topic9215.md)| Overridden.   
...
Protected Method| [Validate](topic9222.md)| Overridden.   
Top
