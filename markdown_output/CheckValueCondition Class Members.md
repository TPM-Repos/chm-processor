...
---|---  
CheckValueCondition Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11844.md)  
...
The following tables list the members exposed by [CheckValueCondition](topic11844.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Value](topic11850.md)| Gets the value to check for.   
