...
---|---  
InvokeTransitionOnExistingSpecificationTask Class Properties   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12370.md)  
...
For a list of all members of this type, see [InvokeTransitionOnExistingSpecificationTask members](topic12371.md).
