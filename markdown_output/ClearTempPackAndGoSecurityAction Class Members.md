...
---|---  
ClearTempPackAndGoSecurityAction Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9654.md)  
...
The following tables list the members exposed by [ClearTempPackAndGoSecurityAction](topic9654.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [StatusMessage](topic9661.md)| Overridden. The current human readable status of this action.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Execute](topic9660.md)| Overridden. Executes this action.   
