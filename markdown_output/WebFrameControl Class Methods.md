...
---|---  
WebFrameControl Class Methods   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9356.md)  
...
For a list of all members of this type, see [WebFrameControl members](topic9357.md).
