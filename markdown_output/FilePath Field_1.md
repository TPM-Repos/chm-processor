...
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks Namespace](topic2159.md) > [StandardRuleTypes Class](topic5461.md) : FilePath Field  
---  
...
---|---  
    ...
    Dim value As String
     
    value = [StandardRuleTypes](topic5461.md).FilePath  
