...
---|---  
SetProjectMetadataValueTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12576.md)  
...
The following tables list the members exposed by [SetProjectMetadataValueTask](topic12576.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [SetProjectMetadataValueTask Constructor](topic12582.md)|   
Top
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12583.md)| Overridden.   
