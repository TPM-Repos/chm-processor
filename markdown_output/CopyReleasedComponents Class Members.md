...
---|---  
CopyReleasedComponents Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9864.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.GroupMaintenance Namespace](topic9628.md) : CopyReleasedComponents Class  
---  
...
The following tables list the members exposed by [CopyReleasedComponents](topic9864.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [StatusMessage](topic9871.md)| Overridden. The current human readable status of this action.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Execute](topic9870.md)| Overridden. Executes this action.   
![Public Method](dotnetimages/publicMethod.gif)| [GetCanExecute](topic9942.md)| Checks to see if the action can be executed or not. (Inherited from [DriveWorks.GroupMaintenance.ProcessActionBase](topic9935.md))  
Top
...
[CopyReleasedComponents Class](topic9864.md)   
