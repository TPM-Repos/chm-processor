...
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic14680.md)  
[DriveWorks.SolidWorks Assembly](topic13342.md) > [DriveWorks.SolidWorks.Components Namespace](topic13925.md) > [ProjectSheet Class](topic14673.md) : ScaleDenominator Property  
---  
...
Provides access to the rule and comment for the sheet scale denominator. 
