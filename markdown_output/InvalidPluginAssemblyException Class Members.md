...
---|---  
InvalidPluginAssemblyException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7191.md)  
...
The following tables list the members exposed by [InvalidPluginAssemblyException](topic7191.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [InvalidPluginAssemblyException Constructor](topic7197.md)| Overloaded.   
Top
