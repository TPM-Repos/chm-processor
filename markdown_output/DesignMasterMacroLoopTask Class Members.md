...
---|---  
DesignMasterMacroLoopTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12206.md)  
...
The following tables list the members exposed by [DesignMasterMacroLoopTask](topic12206.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Defer](topic12215.md)| Gets/sets whether the macro execution should be deferred.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MacroArgument](topic12216.md)| Gets/sets the optional argument to pass to the macro.   
![Public Property](dotnetimages/publicProperty.gif)| [MacroName](topic12217.md)| Gets/sets the name of the macro to run.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12218.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12212.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsDeferred](topic12213.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12214.md)| Overridden.   
