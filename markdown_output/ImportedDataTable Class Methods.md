...
![Public Method](dotnetimages/publicMethod.gif)| [GetData](topic3489.md)| Returns the cached data from the design master. This is much faster than re-loading from file.   
...
![Public Method](dotnetimages/publicMethod.gif)| [SetData](topic3493.md)| Set the data for this table.   
Top
...
![Protected Method](dotnetimages/protectedMethod.gif)| [GetTableData](topic3490.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [InitializeExistingCore](topic3491.md)| Overridden.   
![Protected Method](dotnetimages/protectedMethod.gif)| [InitializeNewCore](topic3492.md)| Overridden.   
