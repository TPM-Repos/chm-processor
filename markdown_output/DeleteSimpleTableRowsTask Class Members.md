...
---|---  
DeleteSimpleTableRowsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12165.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification.StandardTasks Namespace](topic11896.md) : DeleteSimpleTableRowsTask Class  
---  
...
The following tables list the members exposed by [DeleteSimpleTableRowsTask](topic12165.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [DeleteSimpleTableRowsTask Constructor](topic12171.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [FieldNames](topic12173.md)| Gets/sets the column names to match against, delimited by pipe bars.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MatchValues](topic12174.md)| Gets/sets the values to match against, based on the fields specified in the [FieldNames](topic12173.md) property. Values should be delimited with pipe bars.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TableName](topic12176.md)| Gets/sets the name of the simple table to remove rows from.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12175.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12172.md)| Overridden.   
