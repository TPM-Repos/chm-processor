...
---|---  
DeleteTeamTask Class Properties   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12186.md)  
...
For a list of all members of this type, see [DeleteTeamTask members](topic12187.md).
