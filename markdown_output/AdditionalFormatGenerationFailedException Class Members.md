...
---|---  
AdditionalFormatGenerationFailedException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic15170.md)  
...
The following tables list the members exposed by [AdditionalFormatGenerationFailedException](topic15170.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [AdditionalFormatGenerationFailedException Constructor](topic15176.md)| Overloaded.   
Top
