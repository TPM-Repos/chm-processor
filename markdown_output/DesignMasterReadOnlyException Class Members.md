...
---|---  
DesignMasterReadOnlyException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2695.md)  
...
The following tables list the members exposed by [DesignMasterReadOnlyException](topic2695.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [DesignMasterReadOnlyException Constructor](topic2701.md)| Overloaded.   
Top
