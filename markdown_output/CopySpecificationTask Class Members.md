...
---|---  
CopySpecificationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12084.md)  
...
The following tables list the members exposed by [CopySpecificationTask](topic12084.md).
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12093.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12090.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsDeferred](topic12091.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [RequiresSingleContext](topic12092.md)| Overridden.   
