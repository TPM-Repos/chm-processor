...
![](dotnetdiagramimages/image360.png)
...
---|---  
    ...
    Public NotInheritable Class FolderWatcherConfiguration 
...
---|---  
    ...
    public sealed class FolderWatcherConfiguration : [DriveWorks.GroupConnectorInformation](topic3084.md)   
...
**DriveWorks.Connectors.Folder.FolderWatcherConfiguration**  
