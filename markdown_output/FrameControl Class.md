...
![](dotnetdiagramimages/image418.png)
...
---|---  
    ...
    Public NotInheritable Class FrameControl 
...
---|---  
    ...
    [[DefaultSizeAttribute](topic8042.md)(Width=300, Height=300)]
    public sealed class FrameControl : [ControlBase](topic7698.md), [DriveWorks.Extensibility.IExtension](topic7152.md), [DriveWorks.IHasMainProperty](topic2225.md)    
