...
---|---  
CopiedFile Class Methods   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2606.md)  
...
For a list of all members of this type, see [CopiedFile members](topic2607.md).
