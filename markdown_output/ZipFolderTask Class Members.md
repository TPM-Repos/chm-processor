...
---|---  
ZipFolderTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12822.md)  
...
The following tables list the members exposed by [ZipFolderTask](topic12822.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [FolderPath](topic12829.md)| Gets/sets the path of the folder to Zip.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Overwrite](topic12830.md)| Gets/sets whether to overwrite the zip file if already exists.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ZipFileName](topic12832.md)| Gets/sets the of the output Zip filename.   
Top
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12831.md)| Overridden. Gets the class name used when writing to the report.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12828.md)| Overridden.   
