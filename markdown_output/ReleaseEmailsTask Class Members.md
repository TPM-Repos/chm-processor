...
Protected Method| [Execute](topic12483.md)| Overridden. Overridden to implement the logic required to release one or more emails.   
...
Protected Method| [IsRunningRequired](topic12484.md)| Overridden. Overridden to indicate that a running specification is required by the task to execute.   
