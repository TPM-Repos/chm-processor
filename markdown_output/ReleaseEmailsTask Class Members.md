ReleaseEmailsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12477.md)  
...
The following tables list the members exposed by [ReleaseEmailsTask](topic12477.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Emails](topic12485.md)| Gets/sets the identifiers of the emails to release, where "*" is a special identifier meaning all emails.   
...
![Public Property](dotnetimages/publicProperty.gif)![static \(Shared in Visual Basic\)](dotnetimages/static.gif)| [IsInEmailsTask](topic12486.md)| Determines whether the emails task is currently running.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ReleasedEmails](topic12487.md)| The outputs that get fulfilled with a list of the names of the emails that were successfully released when this task was run.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12488.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12483.md)| Overridden. Overridden to implement the logic required to release one or more emails.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12484.md)| Overridden. Overridden to indicate that a running specification is required by the task to execute.   
