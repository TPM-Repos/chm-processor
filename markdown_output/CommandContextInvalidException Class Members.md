...
---|---  
CommandContextInvalidException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic671.md)  
...
The following tables list the members exposed by [CommandContextInvalidException](topic671.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [CommandContextInvalidException Constructor](topic677.md)| Overloaded.   
Top
