...
---|---  
GetControlValueTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12295.md)  
...
The following tables list the members exposed by [GetControlValueTask](topic12295.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [GetControlValueTask Constructor](topic12301.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [SourceControlName](topic12305.md)| Gets/sets the flow property that is the name of the control to copy the value from.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TargetConstantName](topic12306.md)| Gets/sets the flow property that is in control of the constant to store the control value in.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12304.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12302.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12303.md)| Overridden.   
