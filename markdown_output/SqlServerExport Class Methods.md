...
For a list of all members of this type, see [SqlServerExport members](topic5418.md).

# Public Methods

| Name| Description  
---|---|---  
Public Method| [AddColumn](topic5423.md)| Adds a column that is present in the target table.   
Public Method| [AddCommonColumn](topic5424.md)| Adds a common column to the table.   
Public Method| [AddRow](topic5425.md)| Adds a row to the list of export rows.   
Public Method| [ClearColumns](topic5426.md)| Removes all column specifications.   
Public Method| [ClearRows](topic5427.md)| Removes all rows from the list of export rows.   
...
Public Method| [GetExportSummary](topic5429.md)| Retrieve the generation summary for the document in a specifications test mode.   
Public Method| GetLifetimeService|  (Inherited from System.MarshalByRefObject)  
Public Method| [RemoveRow](topic5432.md)| Removes a row from the list of rows to be exported.   
Public Method| [ShouldGenerate](topic5433.md)| Overloaded. Overridden. Determines whether the document should be generated.   
...
Protected Method| [GenerateCore](topic5428.md)| Overridden.   
...
Protected Method| [InitializeExistingCore](topic5430.md)| Overridden.   
Protected Method| [InitializeNewCore](topic5431.md)| Overridden.   
