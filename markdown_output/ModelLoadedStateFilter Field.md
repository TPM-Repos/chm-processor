...
Gets the [DriveWorks.Applications.StateFilter](topic1077.md) which represents the model loaded state. 
...
---|---  
    ...
    Public Shared ReadOnly ModelLoadedStateFilter As [StateFilter](topic1077.md)  
...
---|---  
    ...
     
    value = [CaptureViewHostStates](topic13474.md).ModelLoadedStateFilter  
  
C#|   
---|---  
      
    
    public static readonly [StateFilter](topic1077.md) ModelLoadedStateFilter  
