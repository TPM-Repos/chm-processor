...
Creates new instance of the [PreviewControlException](topic3801.md) via deserialization. 
...
---|---  
    ...
     
    Dim instance As New [PreviewControlException](topic3801.md)(info, context)  
  
C#|   
---|---  
      
    
    protected PreviewControlException( 
