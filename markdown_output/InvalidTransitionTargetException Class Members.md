...
---|---  
InvalidTransitionTargetException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11027.md)  
...
The following tables list the members exposed by [InvalidTransitionTargetException](topic11027.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [InvalidTransitionTargetException Constructor](topic11033.md)| Overloaded.   
Top
