...
Provides access to the drawing's layers. 
...
---|---  
    ...
    Public ReadOnly Property Layers As [ProjectLayerCollection](topic14650.md)  
...
---|---  
    ...
    Dim value As [ProjectLayerCollection](topic14650.md)
     
...
---|---  
    ...
    public [ProjectLayerCollection](topic14650.md) Layers {get;}  
