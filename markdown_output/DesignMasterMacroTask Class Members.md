...
---|---  
DesignMasterMacroTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12219.md)  
...
The following tables list the members exposed by [DesignMasterMacroTask](topic12219.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Defer](topic12228.md)| Gets/sets whether the macro execution should be deferred.   
...
![Public Property](dotnetimages/publicProperty.gif)| [MacroArgument](topic12229.md)| Gets/sets the optional argument to pass to the macro.   
![Public Property](dotnetimages/publicProperty.gif)| [MacroName](topic12230.md)| Gets/sets the name of the macro to run.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12231.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12225.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsDeferred](topic12226.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12227.md)| Overridden.   
