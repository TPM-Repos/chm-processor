...
---|---  
CopyProjectRuleHistoryAction Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9856.md)  
...
The following tables list the members exposed by [CopyProjectRuleHistoryAction](topic9856.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [StatusMessage](topic9863.md)| Overridden. The current human readable status of this action.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Execute](topic9862.md)| Overridden. Executes this action.   
