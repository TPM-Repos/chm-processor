...
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11517.md)  
...
---|---  
    ...
     
    Dim instance As New [SpecificationTaskDetails](topic11510.md)(info, context)  
  
C#|   
---|---  
      
    
    protected SpecificationTaskDetails( 
