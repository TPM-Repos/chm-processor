...
---|---  
CopyCapturedComponentAction Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9686.md)  
...
The following tables list the members exposed by [CopyCapturedComponentAction](topic9686.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Status](topic9694.md)| The current status of the action.   
![Public Property](dotnetimages/publicProperty.gif)| [StatusMessage](topic9695.md)| Overridden. The current human readable status of this action.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Execute](topic9692.md)| Overridden. Executes this action.   
![Public Method](dotnetimages/publicMethod.gif)| [GetCanExecute](topic9693.md)| Overridden. Checks to see if the action can be executed or not.   
Top
