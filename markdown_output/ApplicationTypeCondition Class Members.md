...
---|---  
ApplicationTypeCondition Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11830.md)  
...
The following tables list the members exposed by [ApplicationTypeCondition](topic11830.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Type](topic11836.md)| Gets the type of application for which to check.   
