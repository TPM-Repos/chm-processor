...
---|---  
    ...
    Public Shared ReadOnly DoubleConverter As [IPropertyValueConverter](topic9373.md)  
...
---|---  
    ...
     
    value = [StandardPropertyValueConverters](topic9510.md).DoubleConverter  
  
C#|   
---|---  
      
    
    public static readonly [IPropertyValueConverter](topic9373.md) DoubleConverter  
