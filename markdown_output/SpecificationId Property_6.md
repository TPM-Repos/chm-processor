...
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks Namespace](topic2159.md) > [ProjectSpecialVariables Class](topic4782.md) : SpecificationId Property  
---  
...
---|---  
    ...
    Public MustOverride ReadOnly Property SpecificationId As Integer  
...
---|---  
    ...
    public abstract int SpecificationId {get;}  
