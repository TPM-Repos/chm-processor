...
---|---  
ProjectExtenderLoadException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic4450.md)  
...
The following tables list the members exposed by [ProjectExtenderLoadException](topic4450.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [ProjectExtenderLoadException Constructor](topic4457.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [ExtenderAssemblyPath](topic4459.md)| Gets the path to the extender that failed to load.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetObjectData](topic4458.md)| Overridden.   
