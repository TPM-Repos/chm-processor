...
---|---  
CreateClosedChildSpecificationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12094.md)  
...
The following tables list the members exposed by [CreateClosedChildSpecificationTask](topic12094.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [CreateClosedChildSpecificationTask Constructor](topic12100.md)|   
Top
...
| Name| Description  
---|---|---  
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecificationListNameProperty](topic12103.md)| Gets the property that controls the name of the child specification list to create the child specification on.   
...
![Public Property](dotnetimages/publicProperty.gif)| [CreatedSpecificationId](topic12104.md)| Gets the output that will be fulfilled with the create specification's id after this task has executed.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ProjectNameProperty](topic12105.md)| Gets the property that controls the name of the project to create on the specified child specification list.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TransitionNameProperty](topic12106.md)| Gets the property that controls the name of the transition to invoke on the created child specification list.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12101.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12102.md)| Overridden.   
