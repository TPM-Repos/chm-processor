...
---|---  
RegisterInt64Property(String,FlowPropertyInfo,Int64) Method   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic10939.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification Namespace](topic10764.md) > [FlowProperties Class](topic10905.md) > [RegisterInt64Property Method](topic10935.md) : RegisterInt64Property(String,FlowPropertyInfo,Int64) Method  
---  
...
---|---  
    ...
       ByVal _defaultValue_ As Long _
...
---|---  
    ...
     
    value = instance.RegisterInt64Property(name, info, defaultValue)  
