...
Determines whether one or more rules would prevent the document from being generated. 
...
---|---  
    ...
    Public Property WillGenerate As Boolean  
...
---|---  
    ...
     
    instance.WillGenerate = value
     
    value = instance.WillGenerate  
