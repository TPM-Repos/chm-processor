...
---|---  
EnumerationInterruptedException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2824.md)  
...
The following tables list the members exposed by [EnumerationInterruptedException](topic2824.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [EnumerationInterruptedException Constructor](topic2830.md)| Overloaded.   
Top
