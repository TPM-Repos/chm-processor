...
---|---  
InvokeChildSpecificationTransitionTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12330.md)  
...
The following tables list the members exposed by [InvokeChildSpecificationTransitionTask](topic12330.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [InvokeChildSpecificationTransitionTask Constructor](topic12336.md)|   
Top
...
| Name| Description  
---|---|---  
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecificationListNameProperty](topic12338.md)| Gets the flow property responsible for the name of the child specification list to get the child specification from.   
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecIndexProperty](topic12339.md)| Gets the flow property responsible for the index of the child specification to invoke the transition on.   
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecNameProperty](topic12340.md)| Gets the flow property responsible for the name of the child specification to invoke the transition on.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TransitionNameProperty](topic12342.md)| Gets the flow property responsible for the name of the transition to invoke on the child specification.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12341.md)| Overridden. Gets the reporting class.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12337.md)| Overridden.   
