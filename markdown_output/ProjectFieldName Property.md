...
---|---  
ProjectFieldName Property   
  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Connectors.Database Namespace](topic6754.md) > [DatabaseConnectorConfiguration Class](topic6756.md) : ProjectFieldName Property  
---  
...
---|---  
    ...
    Public Property ProjectFieldName As String  
...
---|---  
    ...
    Dim value As String
     
    instance.ProjectFieldName = value
     
    value = instance.ProjectFieldName  
