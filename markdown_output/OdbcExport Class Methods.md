...
For a list of all members of this type, see [OdbcExport members](topic3764.md).

# Public Methods

| Name| Description  
---|---|---  
Public Method| [AddColumn](topic3769.md)| Adds a column that is present in the target table.   
Public Method| [AddCommonColumn](topic3770.md)| Adds a common column to the table   
Public Method| [AddRow](topic3771.md)| Adds a row to the list of export rows.   
Public Method| [ClearColumns](topic3772.md)| Removes all column specifications.   
Public Method| [ClearRows](topic3773.md)| Removes all rows from the list of export rows.   
...
Public Method| [GetExportSummary](topic3775.md)| Retrieve the generation summary for the document in a specifications test mode.   
Public Method| GetLifetimeService|  (Inherited from System.MarshalByRefObject)  
Public Method| [RemoveRow](topic3778.md)| Remove a row from the list of rows to be exported.   
Public Method| [ShouldGenerate](topic3779.md)| Overloaded. Overridden. Determines whether the document should be generated.   
...
Protected Method| [GenerateCore](topic3774.md)| Overridden.   
...
Protected Method| [InitializeExistingCore](topic3776.md)| Overridden.   
Protected Method| [InitializeNewCore](topic3777.md)| Overridden.   
