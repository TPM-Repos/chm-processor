...
---|---  
DeleteFileTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12134.md)  
...
The following tables list the members exposed by [DeleteFileTask](topic12134.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Path](topic12141.md)| Gets/sets the path to the file to delete.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12142.md)| Overridden. Gets the class name used when writing to the report.   
...
Protected Method| [Execute](topic12140.md)| Overridden.   
