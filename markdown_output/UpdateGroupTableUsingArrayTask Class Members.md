UpdateGroupTableUsingArrayTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12703.md)  
...
The following tables list the members exposed by [UpdateGroupTableUsingArrayTask](topic12703.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [UpdateGroupTableUsingArrayTask Constructor](topic12709.md)|   
Top
...
| Name| Description  
---|---|---  
![Public Property](dotnetimages/publicProperty.gif)| [ArrayValue](topic12711.md)| Gets or sets the table array value for editing the table   
...
![Public Property](dotnetimages/publicProperty.gif)| [ControlColumnNames](topic12712.md)| Gets or sets the control column names   
...
![Public Property](dotnetimages/publicProperty.gif)| [TableName](topic12714.md)| Gets or sets the table name of the table to edit   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12713.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12710.md)| Overridden.   
