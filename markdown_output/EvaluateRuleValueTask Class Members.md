...
---|---  
EvaluateRuleValueTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12258.md)  
...
The following tables list the members exposed by [EvaluateRuleValueTask](topic12258.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [EvaluateRuleValueTask Constructor](topic12264.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [ConstantName](topic12267.md)| Gets/sets the name of the constant to store the result in.   
...
![Public Property](dotnetimages/publicProperty.gif)| [RuleText](topic12269.md)| Gets/sets the rule that will be evaluated once, then have its result evaluated again. The final result of which is stored in the target constant, specified by [ConstantName](topic12267.md).   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12268.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12265.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12266.md)| Overridden.   
