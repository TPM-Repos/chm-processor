...
---|---  
CopyClosedChildSpecificationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12036.md)  
...
The following tables list the members exposed by [CopyClosedChildSpecificationTask](topic12036.md).

# ![](dotnetimages/collapse.gif)Public Properties

| Name| Description  
---|---|---  
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecificationIndex](topic12043.md)| Gets the property responsible for the specification id to match against.   
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecificationListName](topic12044.md)| Gets the property that specifies the child specification list to use.   
![Public Property](dotnetimages/publicProperty.gif)| [ChildSpecificationName](topic12045.md)| Gets the property responsible for the specification name to match against.   
...
![Public Property](dotnetimages/publicProperty.gif)| [CopiedSpecificationNameConstantName](topic12046.md)| Gets the property responsible for the name of the constant to place the copied specification's name in.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12047.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12042.md)| Overridden.   
