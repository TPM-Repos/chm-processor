...
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic8051.md)  
...
The following tables list the members exposed by [DialogButton](topic8051.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [DialogButton Constructor](topic8057.md)| Initializes a new instance of the [DialogButton](topic8051.md) type.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [DialogName](topic8061.md)| Gets/sets the name of the dialog to show when the button is clicked.   
...
![Public Property](dotnetimages/publicProperty.gif)| [PictureDefault](topic8062.md)| Gets/sets the location of the default picture to use as the default image for this dialog button.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureHover](topic8063.md)| Gets/sets the location of the picture to use as the image for this dialog button when it's in a hover state.   
![Public Property](dotnetimages/publicProperty.gif)| [PicturePressed](topic8064.md)| Gets/sets the location of the picture to use as the image for this dialog button when it's in a pressed state.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureSizeMode](topic8065.md)| Gets/sets the picture sizing mode for this dialog button.   
![Public Property](dotnetimages/publicProperty.gif)| [PictureStyle](topic8066.md)| Gets/sets the picture appearance style for this dialog button.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TaskListEnabled](topic8067.md)| Gets/sets the enabled state of the dialog task list.   
...
![Public Method](dotnetimages/publicMethod.gif)| [Invoke](topic8058.md)| Overloaded. Shows the dialog named by the [DialogName](topic8061.md) property.   
