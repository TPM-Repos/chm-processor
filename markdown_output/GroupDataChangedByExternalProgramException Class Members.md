...
---|---  
GroupDataChangedByExternalProgramException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic13763.md)  
...
The following tables list the members exposed by [GroupDataChangedByExternalProgramException](topic13763.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [GroupDataChangedByExternalProgramException Constructor](topic13769.md)| Overloaded.   
Top
