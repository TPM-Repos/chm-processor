...
Gets the name of the parameter responsible for deciding which sheets to export to a PDF. 
...
---|---  
    ...
    Public Const PdfSheetNames As String  
...
---|---  
    ...
    Dim value As String
     
    value = [FileFormatStandardParameters](topic13624.md).PdfSheetNames  
  
C#|   
---|---  
      
    
    public const string PdfSheetNames  
