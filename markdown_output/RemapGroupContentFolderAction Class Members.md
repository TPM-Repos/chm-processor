...
---|---  
RemapGroupContentFolderAction Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9959.md)  
...
The following tables list the members exposed by [RemapGroupContentFolderAction](topic9959.md).
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Execute](topic9965.md)| Overridden. Executes this action.   
![Public Method](dotnetimages/publicMethod.gif)| [GetCanExecute](topic9966.md)| Overridden. Checks to see if the action can be executed or not.   
Top
