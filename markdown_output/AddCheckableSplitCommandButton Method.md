...
---|---  
AddCheckableSplitCommandButton Method   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic105.md)  
[DriveWorks.Applications Assembly](topic13.md) > [DriveWorks.Applications Namespace](topic16.md) > [ICommandBarGroup Interface](topic99.md) : AddCheckableSplitCommandButton Method  
---  
...
Adds a new checkable split command button, which has virtualized drop down items, to the group. 
...
---|---  
    ...
    Function AddCheckableSplitCommandButton( _
    ...
    ) As [ICheckableSplitCommandButton](topic72.md)  
...
---|---  
    ...
    Dim value As [ICheckableSplitCommandButton](topic72.md)
     
    value = instance.AddCheckableSplitCommandButton(commandName, commandContext, displayHint, unavailableBehavior)  
  
C#|   
---|---  
      
    
    [ICheckableSplitCommandButton](topic72.md) AddCheckableSplitCommandButton( 
