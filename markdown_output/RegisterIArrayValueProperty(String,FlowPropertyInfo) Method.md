...
---|---  
RegisterIArrayValueProperty(String,FlowPropertyInfo) Method   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic10928.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Specification Namespace](topic10764.md) > [FlowProperties Class](topic10905.md) > [RegisterIArrayValueProperty Method](topic10925.md) : RegisterIArrayValueProperty(String,FlowPropertyInfo) Method  
---  
...
---|---  
    ...
     
    value = instance.RegisterIArrayValueProperty(name, info)  
