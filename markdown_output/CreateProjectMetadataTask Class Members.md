...
---|---  
CreateProjectMetadataTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12107.md)  
...
The following tables list the members exposed by [CreateProjectMetadataTask](topic12107.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [CreateProjectMetadataTask Constructor](topic12113.md)|   
Top
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12114.md)| Overridden.   
