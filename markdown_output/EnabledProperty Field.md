...
Provides the property store for the [Enabled](topic7727.md) property. 
...
---|---  
    ...
    Public Shared ReadOnly EnabledProperty As [DynamicProperty](topic9398.md)  
...
---|---  
    ...
     
    value = [ControlBase](topic7698.md).EnabledProperty  
  
C#|   
---|---  
      
    
    public static readonly [DynamicProperty](topic9398.md) EnabledProperty  
