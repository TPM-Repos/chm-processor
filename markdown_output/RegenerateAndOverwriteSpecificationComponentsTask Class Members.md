...
---|---  
RegenerateAndOverwriteSpecificationComponentsTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12456.md)  
...
The following tables list the members exposed by [RegenerateAndOverwriteSpecificationComponentsTask](topic12456.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [RegenerateAndOverwriteSpecificationComponentsTask Constructor](topic12462.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [SpecificationId](topic12465.md)| Gets/sets the specification id of the specification whose components to mark for regeneration and have their overwrite flag set.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12464.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12463.md)| Overridden.   
