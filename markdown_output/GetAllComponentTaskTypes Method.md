...
---|---  
    ...
    Public Shared Function GetAllComponentTaskTypes( _
...
---|---  
    ...
     
    value = [ProjectMaintenance](topic4579.md).GetAllComponentTaskTypes(projectPath)  
  
C#|   
---|---  
      
    
    public static IEnumerable<string> GetAllComponentTaskTypes( 
