...
---|---  
ComponentTaskParameterInfo Class Members   
See Also Properties Methods [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic6603.md)  
...
The following tables list the members exposed by [ComponentTaskParameterInfo](topic6603.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ComponentTaskParameterInfo Constructor](topic6609.md)| Overloaded.   
Top
