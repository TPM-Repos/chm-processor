...
---|---  
GetConstantValueTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12283.md)  
...
The following tables list the members exposed by [GetConstantValueTask](topic12283.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [GetConstantValueTask Constructor](topic12289.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [SourceConstantName](topic12293.md)| Gets/sets the flow property that is the name of the control to copy the value from.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TargetConstantName](topic12294.md)| Gets/sets the flow property that is in control of the constant to store the control value in.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12292.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12290.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12291.md)| Overridden.   
