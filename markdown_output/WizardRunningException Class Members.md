...
---|---  
WizardRunningException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic1257.md)  
...
The following tables list the members exposed by [WizardRunningException](topic1257.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [WizardRunningException Constructor](topic1263.md)| Overloaded.   
Top
