...
---|---  
CopyGroupTeamAction Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9806.md)  
...
The following tables list the members exposed by [CopyGroupTeamAction](topic9806.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Status](topic9814.md)| The current status of the action.   
![Public Property](dotnetimages/publicProperty.gif)| [StatusMessage](topic9815.md)| Overridden. The current human readable status of this action.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Execute](topic9812.md)| Overridden. Executes this action.   
![Public Method](dotnetimages/publicMethod.gif)| [GetCanExecute](topic9813.md)| Overridden. Checks to see if the action can be executed or not.   
Top
