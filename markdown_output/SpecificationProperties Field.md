...
---|---  
    ...
    Public Const SpecificationProperties As String  
...
---|---  
    ...
    Dim value As String
     
    value = [AdministratorViewNames](topic1388.md).SpecificationProperties  
  
C#|   
---|---  
      
    
    public const string SpecificationProperties  
