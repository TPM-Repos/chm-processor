...
---|---  
RunMacroInHostedSpecificationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12523.md)  
...
The following tables list the members exposed by [RunMacroInHostedSpecificationTask](topic12523.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [RunMacroInHostedSpecificationTask Constructor](topic12529.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [MacroArgumentProperty](topic12532.md)| The property for the macro argument to hand to the macro.   
![Public Property](dotnetimages/publicProperty.gif)| [MacroNameProperty](topic12533.md)| The property for the macro name of the marco to run.   
...
![Public Property](dotnetimages/publicProperty.gif)| [SpecificationHostNameProperty](topic12535.md)| The property for the specifiation host name that hosts the specification to run the macro in.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12534.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12530.md)| Overridden.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [IsRunningRequired](topic12531.md)| Overridden.   
