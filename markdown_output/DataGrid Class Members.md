...
See Also Fields Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7838.md)  
...
The following tables list the members exposed by [DataGrid](topic7838.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [DataGrid Constructor](topic7844.md)| Initializes a new instance of the [DataGrid](topic7838.md) type.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [ConnectionString](topic7848.md)| Gets the connection string built from the [Database](topic7849.md), [UserName](topic7854.md), and [Password](topic7851.md) properties.   
![Public Property](dotnetimages/publicProperty.gif)| [Database](topic7849.md)| Gets/sets the data source name of the database to query.   
...
![Public Property](dotnetimages/publicProperty.gif)| [FieldNames](topic7850.md)| Gets/sets the names of the fields to retrieve.   
...
![Public Property](dotnetimages/publicProperty.gif)| [Password](topic7851.md)| Gets/sets the password of the user to use when performing the query.   
...
![Public Property](dotnetimages/publicProperty.gif)| [QueryString](topic7852.md)| Gets the query string built from the [WhereClause](topic7855.md), [TableName](topic7853.md), and [FieldNames](topic7850.md) properties.   
...
![Public Property](dotnetimages/publicProperty.gif)| [TableName](topic7853.md)| Gets/sets the name of the table to query.   
...
![Public Property](dotnetimages/publicProperty.gif)| [UserName](topic7854.md)| Gets/sets the name of the user to use when performing the query.   
...
![Public Property](dotnetimages/publicProperty.gif)| [WhereClause](topic7855.md)| Gets/sets the where clause for the database query.   
...
Public Method| [ExecuteQuery](topic7845.md)| Executes the query represented by the data grid, and returns the result as a data table.   
...
Protected Method| [OnInitialized](topic7846.md)| Overridden.   
...
Protected Method| [OnValueChanged](topic7847.md)| Overridden.   
...
| Name| Description  
---|---|---  
![Public Event](dotnetimages/publicEvent.gif)| [ConnectionStringChanged](topic7862.md)| Raised when the value of the [ConnectionString](topic7848.md) property changes.   
...
![Public Event](dotnetimages/publicEvent.gif)| [QueryStringChanged](topic7863.md)| Raised when the value of the [QueryString](topic7852.md) property changes.   
