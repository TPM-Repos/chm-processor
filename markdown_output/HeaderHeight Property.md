...
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Forms Namespace](topic7266.md) > [DataTableControl Class](topic7864.md) : HeaderHeight Property  
---  
...
Gets the height value to apply to the header row of the data table. 
