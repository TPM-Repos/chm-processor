...
---|---  
InvalidDocumentPathException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic3531.md)  
...
The following tables list the members exposed by [InvalidDocumentPathException](topic3531.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [InvalidDocumentPathException Constructor](topic3537.md)| Creates a new instance of the [InvalidDocumentPathException](topic3531.md) class.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [DocumentName](topic3538.md)| Gets the name of the document containing an invalid filename or relative path rule.   
