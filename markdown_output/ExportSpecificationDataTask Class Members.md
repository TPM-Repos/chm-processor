...
---|---  
ExportSpecificationDataTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic12270.md)  
...
The following tables list the members exposed by [ExportSpecificationDataTask](topic12270.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [ConstantsToInclude](topic12277.md)| Gets/sets the list of constants to include within the file to export.   
...
![Public Property](dotnetimages/publicProperty.gif)| [ExportFormat](topic12278.md)| Gets/sets the format of the file to export.   
...
![Public Property](dotnetimages/publicProperty.gif)| [OutputFileName](topic12279.md)| Gets/sets the file name of the file to export.   
...
![Public Property](dotnetimages/publicProperty.gif)| [OverwriteFlag](topic12280.md)| Gets/sets whether to overwrite an existing file or not.   
![Public Property](dotnetimages/publicProperty.gif)| [ProjectTablesToInclude](topic12281.md)| Gets/sets the list of project tables to include within the file to export.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic12282.md)| Overridden. Gets the class name used for reporting.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic12276.md)| Overridden.   
