...
Gets/sets whether margin guides are enabled. 
...
---|---  
    ...
    Property MarginGuidesEnabled As Boolean  
...
---|---  
    ...
     
    instance.MarginGuidesEnabled = value
     
    value = instance.MarginGuidesEnabled  
  
C#|   
---|---  
      
    
    bool MarginGuidesEnabled {get; set;}  
