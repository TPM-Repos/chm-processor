...
---|---  
MessageDataCorruptException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic3692.md)  
...
The following tables list the members exposed by [MessageDataCorruptException](topic3692.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [MessageDataCorruptException Constructor](topic3698.md)| Overloaded.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [Message](topic3703.md)| Overridden.   
