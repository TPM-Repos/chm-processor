...
---|---  
DocumentDesignerAttribute Class Members   
See Also Properties Methods [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic1568.md)  
...
The following tables list the members exposed by [DocumentDesignerAttribute](topic1568.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [DocumentDesignerAttribute Constructor](topic1574.md)| Overloaded.   
Top
