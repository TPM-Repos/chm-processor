...
---|---  
GroupUpgradeAbortedException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic3428.md)  
...
The following tables list the members exposed by [GroupUpgradeAbortedException](topic3428.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [GroupUpgradeAbortedException Constructor](topic3434.md)| Overloaded.   
Top
