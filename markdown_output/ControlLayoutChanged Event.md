...
---|---  
ControlLayoutChanged Event   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7785.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Forms Namespace](topic7266.md) > [ControlCollection Class](topic7766.md) : ControlLayoutChanged Event  
---  
...
---|---  
    ...
    Public Event ControlLayoutChanged As [ControlEventHandler](topic9366.md)  
...
---|---  
    ...
     
    AddHandler instance.ControlLayoutChanged, handler  
  
C#|   
---|---  
      
    
    public event [ControlEventHandler](topic9366.md) ControlLayoutChanged  
