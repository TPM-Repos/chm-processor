...
---|---  
ComponentTaskNotFoundException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic7167.md)  
...
The following tables list the members exposed by [ComponentTaskNotFoundException](topic7167.md).

# ![](dotnetimages/collapse.gif)Protected Constructors

| Name| Description  
---|---|---  
![Protected Constructor](dotnetimages/protectedConstructor.gif)| [ComponentTaskNotFoundException Constructor](topic7174.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [TaskType](topic7176.md)| Gets the full type name of the task that is missing.   
Top
...
![Public Method](dotnetimages/publicMethod.gif)| [GetObjectData](topic7175.md)| Overridden.   
