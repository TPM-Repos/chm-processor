...
---|---  
[BeginAdd(String)](topic8191.md)| Starts the adding process for this item list. Informs the specification context that a dialog is being opened etc.   
[BeginAdd(String,Boolean)](topic8192.md)| Starts the adding process for this item list. Informs the specification context that a dialog is being opened etc.   
