...
---|---  
CopyGroupOptionsSerializerException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic2615.md)  
...
The following tables list the members exposed by [CopyGroupOptionsSerializerException](topic2615.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [CopyGroupOptionsSerializerException Constructor](topic2621.md)| Overloaded.   
Top
