...
---|---  
    ...
    Public Shared Function ConvertBooleanToDateTime( _
...
---|---  
    ...
    Dim value As Object
     
    value = [StoreConverter](topic9528.md).ConvertBooleanToDateTime(value)  
  
C#|   
---|---  
      
    
    public static object ConvertBooleanToDateTime( 
       object _value_
    )  
