...
---|---  
CancelHostedSpecificationTask Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic11961.md)  
...
The following tables list the members exposed by [CancelHostedSpecificationTask](topic11961.md).

# ![](dotnetimages/collapse.gif)Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [CancelHostedSpecificationTask Constructor](topic11967.md)|   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [SpecificationHostNameProperty](topic11970.md)| The property for the name of the specification host that hosts the specification to cancel.   
...
| Name| Description  
---|---|---  
![Protected Property](dotnetimages/protectedProperty.gif)| [ReportingClass](topic11969.md)| Overridden. Gets the class name used when writing to the report.   
...
![Protected Method](dotnetimages/protectedMethod.gif)| [Execute](topic11968.md)| Overridden.   
