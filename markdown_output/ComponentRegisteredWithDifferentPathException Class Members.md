...
---|---  
ComponentRegisteredWithDifferentPathException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic13517.md)  
...
The following tables list the members exposed by [ComponentRegisteredWithDifferentPathException](topic13517.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [ComponentRegisteredWithDifferentPathException Constructor](topic13523.md)| Overloaded.   
Top
