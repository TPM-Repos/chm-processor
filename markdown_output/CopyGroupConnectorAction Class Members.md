...
---|---  
CopyGroupConnectorAction Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9727.md)  
...
The following tables list the members exposed by [CopyGroupConnectorAction](topic9727.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [Status](topic9734.md)| The current status of the action.   
![Public Property](dotnetimages/publicProperty.gif)| [StatusMessage](topic9735.md)| Overridden. The current human readable status of this action.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Execute](topic9733.md)| Overridden. Executes this action.   
