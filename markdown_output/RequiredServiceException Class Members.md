RequiredServiceException Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic915.md)  
...
The following tables list the members exposed by [RequiredServiceException](topic915.md).

# Public Constructors

| Name| Description  
---|---|---  
![Public Constructor](dotnetimages/publicConstructor.gif)| [RequiredServiceException Constructor](topic921.md)| Overloaded.   
Top
...
![Public Property](dotnetimages/publicProperty.gif)| [ServiceName](topic925.md)| Gets the name of the required service that was not present.   
...
![Public Method](dotnetimages/publicMethod.gif)| [GetObjectData](topic924.md)| Overridden. Sets the info with information about the instance.   
