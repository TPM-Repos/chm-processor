...
---|---  
CreateTxDeleteComponentTaskReleaseCondition Method   
See Also [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic13084.md)  
[DriveWorks.Engine Assembly](topic2156.md) > [DriveWorks.Transactions Namespace](topic12835.md) > [ProjectTransactionFactory Class](topic12928.md) : CreateTxDeleteComponentTaskReleaseCondition Method  
---  
...
---|---  
    ...
    Public Function CreateTxDeleteComponentTaskReleaseCondition( _
...
---|---  
    ...
     
    value = instance.CreateTxDeleteComponentTaskReleaseCondition(component, taskName, conditionName)  
  
C#|   
---|---  
      
    
    public [ITransaction](topic12837.md) CreateTxDeleteComponentTaskReleaseCondition( 
