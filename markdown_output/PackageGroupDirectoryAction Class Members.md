...
---|---  
PackageGroupDirectoryAction Class Members   
See Also Properties Methods Events [Send Feedback](mailto:apisupport@driveworks.co.uk?subject=Documentation Feedback: topic9917.md)  
...
The following tables list the members exposed by [PackageGroupDirectoryAction](topic9917.md).
...
![Public Property](dotnetimages/publicProperty.gif)| [StatusMessage](topic9924.md)| Overridden. The current human readable status of this action.   
...
| Name| Description  
---|---|---  
![Public Method](dotnetimages/publicMethod.gif)| [Execute](topic9923.md)| Overridden. Executes this action.   
